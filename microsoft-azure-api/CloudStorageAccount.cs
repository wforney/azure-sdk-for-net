...
namespace Microsoft.WindowsAzure
{
    ...
    /// <summary>Represents a Windows Azure storage account.</summary>
    public sealed class CloudStorageAccount
    {
        #region Constants and Fields

        /// <summary>The setting name for the account key.</summary>
        internal const string AccountKeyName = "AccountKey";

        /// <summary>The setting name for the account name.</summary>
        internal const string AccountNameName = "AccountName";

        /// <summary>The setting name for a custom blob storage endpoint.</summary>
        internal const string BlobEndpointName = "BlobEndpoint";

        /// <summary>The setting name for using the default storage endpoints with the specified protocol.</summary>
        internal const string DefaultEndpointsProtocolName = "DefaultEndpointsProtocol";

        /// <summary>The setting name for specifying a development storage proxy Uri.</summary>
        internal const string DevelopmentStorageProxyUriName = "DevelopmentStorageProxyUri";

        /// <summary>The setting name for a custom queue endpoint.</summary>
        internal const string QueueEndpointName = "QueueEndpoint";

        /// <summary>The setting name for a shared access key.</summary>
        internal const string SharedAccessSignatureName = "SharedAccessSignature";

        /// <summary>The setting name for a custom table storage endpoint.</summary>
        internal const string TableEndpointName = "TableEndpoint";

        /// <summary>The setting name for using the development storage.</summary>
        internal const string UseDevelopmentStorageName = "UseDevelopmentStorage";

        /// <summary>The root blob storage DNS name.</summary>
        private const string BlobBaseDnsName = "blob.core.windows.net";

        /// <summary>The default account key for the development storage.</summary>
        private const string DevstoreAccountKey =
            "Eby8vdM02xNOcqFlqUwJPLlmEtlCDXJ1OUzFT50uSRZ6IFsuFq2UVErCz4I6tq/K1SZFPTOtr/KBHBeksoGMGw==";

        /// <summary>The default account name for the development storage.</summary>
        private const string DevstoreAccountName = "devstoreaccount1";

        /// <summary>The credentials string used to test for the development storage credentials.</summary>
        private const string DevstoreCredentialInString =
            AccountNameName + "=" + DevstoreAccountName + ";" + AccountKeyName + "=" + DevstoreAccountKey;

        /// <summary>The root queue DNS name.</summary>
        private const string QueueBaseDnsName = "queue.core.windows.net";

        /// <summary>The root table storage DNS name.</summary>
        private const string TableBaseDnsName = "table.core.windows.net";

        /// <summary>Validator for the AccountKey setting. Must be a valid base64 string.</summary>
        private static readonly AccountSetting AccountKeySetting = Setting(AccountKeyName, IsValidBase64String);

        /// <summary>Validator for the AccountName setting. No restrictions.</summary>
        private static readonly AccountSetting AccountNameSetting = Setting(AccountNameName);

        /// <summary>Validator for the BlobEndpoint setting. Must be a valid Uri.</summary>
        private static readonly AccountSetting BlobEndpointSetting = Setting(BlobEndpointName, IsValidUri);

        /// <summary>Validator for the DefaultEndpointsProtocol setting. Must be either "http" or "https".</summary>
        private static readonly AccountSetting DefaultEndpointsProtocolSetting = Setting(
            DefaultEndpointsProtocolName, "http", "https");

        /// <summary>Validator for the DevelopmentStorageProxyUri setting. Must be a valid Uri.</summary>
        private static readonly AccountSetting DevelopmentStorageProxyUriSetting =
            Setting(DevelopmentStorageProxyUriName, IsValidUri);

        /// <summary>Validator for the QueueEndpoint setting. Must be a valid Uri.</summary>
        private static readonly AccountSetting QueueEndpointSetting = Setting(QueueEndpointName, IsValidUri);

        /// <summary>Validator for the SharedAccessSignature setting. No restrictions.</summary>
        private static readonly AccountSetting SharedAccessSignatureSetting = Setting(SharedAccessSignatureName);

        /// <summary>Validator for the TableEndpoint setting. Must be a valid Uri.</summary>
        private static readonly AccountSetting TableEndpointSetting = Setting(TableEndpointName, IsValidUri);

        /// <summary>Validator for the UseDevelopmentStorage setting. Must be "true".</summary>
        private static readonly AccountSetting UseDevelopmentStorageSetting = Setting(UseDevelopmentStorageName, "true");

        /// <summary>Stores the user-specified configuration setting publisher.</summary>
        private static Action<string, Func<string, bool>> configurationSettingPublisher;

        /// <summary>Singleton instance for the development storage account.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudStorageAccount"/> class using the specified account credentials and service endpoints.</summary>
        ...
        public CloudStorageAccount(
            StorageCredentials storageCredentials, Uri blobEndpoint, Uri queueEndpoint, Uri tableEndpoint)
        {
        ...
        /// <summary>Gets a <see cref="CloudStorageAccount"/> object that references the development storage account.</summary>
        /// <value>A reference to the development storage account. </value>
        public static CloudStorageAccount DevelopmentStorageAccount
        {
            get
            {
                return devStoreAccount ?? (devStoreAccount = GetDevelopmentStorageAccount(new Uri("http://127.0.0.1")));
            }
        }

        /// <summary>Gets the endpoint for the Blob service, as configured for the storage account.</summary>
        /// <value>The Blob service endpoint. </value>
        public Uri BlobEndpoint { get; private set; }

        /// <summary>Gets the credentials used to create this <see cref="CloudStorageAccount"/> object.</summary>
        ...
        /// <summary>Gets the endpoint for the Queue service, as configured for the storage account.</summary>
        /// <value>The Queue service endpoint. </value>
        public Uri QueueEndpoint { get; private set; }

        /// <summary>Gets the endpoint for the Table service, as configured for the storage account.</summary>
        ...
        /// <summary>Create a new instance of a <see cref="CloudStorageAccount"/> object from a specified configuration setting. This method may be called only after the <see cref="SetConfigurationSettingPublisher"/> method has been called to configure the global configuration setting publisher.</summary>
        ...
        /// <summary>Parses a connection string and returns a <see cref="CloudStorageAccount"/> created from the connection string.</summary>
        ...
        ///     is not a valid connection string.</exception>
        ...
        /// <summary>Sets the global configuration setting publisher for the storage account, which will be called when the account access keys are updated in the service configuration file.</summary>
        /// <param name="configurationSettingPublisherParam">The configuration setting publisher for the storage account. </param>
        public static void SetConfigurationSettingPublisher(
            Action<string, Func<string, bool>> configurationSettingPublisherParam)
        {
            configurationSettingPublisher = configurationSettingPublisherParam;
        }

        /// <summary>Indicates whether a connection string can be parsed to return a <see cref="CloudStorageAccount"/> object.</summary>
        /// <param name="value">The connection string to parse. </param>
        /// <param name="account">A <see cref="CloudStorageAccount"/> object to hold the instance returned if the connection string can be parsed. </param>
        ...
        /// <summary>Returns a connection string for this storage account, without sensitive data.</summary>
        ...
        /// <summary>Returns a connection string for the storage account, optionally with sensitive data.</summary>
        ...
        public string ToString(bool exportSecrets)
        {
            ...
            else if (this.Credentials != null && this.Credentials.AccountName == DevstoreAccountName
                     && this.Credentials.ToString(true) == DevstoreCredentialInString && this.BlobEndpoint != null
                     && this.QueueEndpoint != null && this.TableEndpoint != null
                     ...
                     && this.QueueEndpoint.Scheme == this.TableEndpoint.Scheme)
            {
                ...
                settings.Add(
                    string.Format(
                        "{0}={1}://{2}",
                        DevelopmentStorageProxyUriName,
                        this.BlobEndpoint.Scheme,
                        this.BlobEndpoint.Host));
            }
        ...
        /// <summary>Returns a <see cref="CloudStorageAccount"/> with development storage credentials using the specified proxy Uri.</summary>
        ...
        internal static CloudStorageAccount GetDevelopmentStorageAccount(Uri proxyUri)
        {
            ...
            var prefix = proxyUri.Scheme + "://" + proxyUri.Host;
        ...
        /// <summary>Internal implementation of Parse/TryParse.</summary>
        ...
        /// <summary>Settings filter that requires all specified settings be present and valid.</summary>
        ...
        private static Func<NameValueCollection, NameValueCollection> AllRequired(
            params AccountSetting[] requiredSettings)
        {
            return settings =>
                {
        ...
        /// <summary>Settings filter that ensures that at least one setting is present.</summary>
        /// <param name="atLeastOneSettings">A list of settings of which one must be present. </param>
        /// <returns>The remaining settings or null if the filter's requirement is not satisfied. </returns>
        private static Func<NameValueCollection, NameValueCollection> AtLeastOne(
            params AccountSetting[] atLeastOneSettings)
        {
            return settings =>
                {
                    var result = new NameValueCollection(settings);
        ...
        /// <summary>Gets a StorageCredentials object corresponding to whatever credentials are supplied in the given settings.</summary>
        ...
        /// <summary>Gets the default blob endpoint using specified settings.</summary>
        ...
        /// <summary>Gets the default blob endpoint using the specified protocol and account name.</summary>
        ...
        /// <summary>Gets the default queue endpoint using the specified settings.</summary>
        ...
        /// <summary>Gets the default queue endpoint using the specified protocol and account name.</summary>
        /// <param name="scheme">The protocol to use. </param>
        /// <param name="accountName">The name of the storage account. </param>
        /// <returns>The default queue endpoint. </returns>
        ...
        /// <summary>Gets the default table endpoint using the specified settings.</summary>
        /// <param name="settings">The settings. </param>
        ...
        /// <summary>Gets the default table endpoint using the specified protocol and account name.</summary>
        /// <param name="scheme">The protocol to use. </param>
        /// <param name="accountName">The name of the storage account. </param>
        /// <returns>The default table endpoint. </returns>
        ...
        /// <summary>Determines whether the specified setting value is a valid base64 string.</summary>
        ...
        /// <summary>Validation function that validates Uris.</summary>
        ...
        /// <summary>Tests to see if a given list of settings matches a set of filters exactly.</summary>
        /// <param name="settings">The settings to check. </param>
        /// <param name="constraints">A list of filters to check. </param>
        /// <returns>If any filter returns null, false. If there are any settings left over after all filters are processed, false. Otherwise true. </returns>
        private static bool MatchesSpecification(
            NameValueCollection settings, params Func<NameValueCollection, NameValueCollection>[] constraints)
        {
        ...
        /// <summary>Settings filter that removes optional values.</summary>
            ...
            return settings =>
                {
                    ...
                    foreach (var requirement in optionalSettings.Where(requirement => result[requirement.Key] != null && requirement.Value(result[requirement.Key])))
                    {
                        result.Remove(requirement.Key);
                    }
        ...
        /// <summary>Tokenizes input and stores name/value pairs in a NameValueCollection.</summary>
        /// <param name="s">The string to parse. </param>
        ...
        /// <summary>Encapsulates a validation rule for an enumeration based account setting.</summary>
        ...
        private static AccountSetting Setting(string name, params string[] validValues)
        {
            return new AccountSetting(
                name,
                settingValue => validValues.Length == 0 || validValues.Any(validValue => settingValue == validValue));
        }

        /// <summary>Encapsulates a validation rule using a func.</summary>
        /// <param name="name">The name of the setting. </param>
        ...
        /// <summary>Settings filter that ensures that a valid combination of credentials is present.</summary>
        /// <returns>The remaining settings or null if the filter's requirement is not satisfied. </returns>
        ...
        /// <summary>Encapsulates a mutable storage credentials object.</summary>
        internal class StorageAccountConfigurationSetting
        {
            #region Constants and Fields

            /// <summary>Stores the mutable storage credentials.</summary>
            ...
            /// <summary>Initializes a new instance of the <see cref="StorageAccountConfigurationSetting"/> class.</summary>
            ...
            public StorageAccountConfigurationSetting(string configurationSettingName)
            {
                ...
                configurationSettingPublisher(configurationSettingName, this.SetConfigurationValue);
            }
            ...
            /// <summary>Gets or sets the cloud storage account.</summary>
            /// <value>The cloud storage account. </value>
            public CloudStorageAccount CloudStorageAccount { get; internal set; }

            /// <summary>Gets or sets the name of the configuration setting from which we retrieve storage account information.</summary>
            /// <value>The configuration setting name.</value>
