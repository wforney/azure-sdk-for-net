...
namespace Microsoft.WindowsAzure.StorageClient.Tasks
{
    ...
    /// <summary>Encapsulates methods for wrapping tasks in timeouts.</summary>
    internal static class TimeoutHelper
    {
        #region Methods

        /// <summary>Gets a timeout wrapped task.</summary>
        ...
        /// <summary>Creates a localized timeout exception object.</summary>
        /// <param name="timeout">The timeout. </param>
        ...
        internal static Exception ThrowTimeoutError(TimeSpan timeout)
        {
            ...
            var errorMessage = string.Format(
                CultureInfo.CurrentCulture, SR.ClientSideTimeoutError, timeout.RoundUpToSeconds());

            return new TimeoutException(errorMessage);
        }

        /// <summary>Gets a timeout task sequence.</summary>
        /// <typeparam name="T">The type of the result. </typeparam>
        /// <param name="timeout">The timeout. </param>
