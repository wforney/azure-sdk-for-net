...
namespace Microsoft.WindowsAzure.StorageClient.Tasks
{
    ...
    /// <summary>A set of extension methods for a webrequest.</summary>
    internal static class WebRequestExtensions
    {
        #region Methods

        /// <summary>Gets an asynchronous request stream for a given Web request.</summary>
        ...
        /// <summary>Gets an asynchronous response to a given Web request.</summary>
        /// <param name="req">The requested that is used for operation. </param>
        /// <param name="service">The service. </param>
        /// <param name="timeout">The timeout. </param>
        /// <returns>A task that yields the response. </returns>
        [DebuggerNonUserCode]
        internal static Task<WebResponse> GetResponseAsyncWithTimeout(
            this WebRequest req, CloudQueueClient service, TimeSpan? timeout)
        {
            var serverTask = req.GetResponseAsync(service);

            var wrappedTask = TimeoutHelper.GetTimeoutWrappedTask(timeout, serverTask);
            return wrappedTask;
        }
        ...
        [DebuggerNonUserCode]
        internal static Task<WebResponse> GetResponseAsyncWithTimeout(
            this WebRequest req, CloudBlobClient service, TimeSpan? timeout)
        {
            var serverTask = req.GetResponseAsync(service);
        ...
        [DebuggerNonUserCode]
        internal static Task<WebResponse> GetResponseAsyncWithTimeout(
            this WebRequest req, CloudTableClient service, TimeSpan? timeout)
        {
            var serverTask = req.GetResponseAsync(service);
        ...
        private static Task<WebResponse> GetResponseAsync(this WebRequest req, CloudBlobClient service)
        {
            return new APMTask<WebResponse>(
                req.BeginGetResponse, asyncresult => service.EndGetResponse(asyncresult, req), req.Abort);
        }
