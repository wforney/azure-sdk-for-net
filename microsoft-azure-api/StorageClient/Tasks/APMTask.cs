...
namespace Microsoft.WindowsAzure.StorageClient.Tasks
{
    ...
    /// <summary>A task that implements the conventional BeginXX(), EndXX() pattern.</summary>
    ...
    internal class APMTask : APMTask<NullTaskReturn>
    {
        ...
        /// <summary>Initializes a new instance of the APMTask class for sequence without any return value.</summary>
    ...
    internal class APMTask<T> : Task<T>
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="APMTask{T}"/> class. Initializes a new instance of the APMTask class for use with normal APM.</summary>
        /// <param name="begin">The APM function to begin operation. </param>
        /// <param name="end">The APM functon to end the operation. </param>
        [DebuggerNonUserCode]
        ...
        /// <summary>Implements the abort functionality.</summary>
        [DebuggerNonUserCode]
        ...
        /// <summary>Implementation of the library execution. Performs the APM operation.</summary>
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", 
            Justification = "The exception is logged.")]
        [SuppressMessage("Anvil.<Leak!Disposable>", "<1037>", 
            Justification =
                "IAsyncResult is not neccesarily disposable as it is retrieved from any Func<IAsyncResult>, will go out of scope.")]
        [DebuggerNonUserCode]
        protected override void ExecuteInternal()
        {
            try
            {
                var ar = this.BeginFunc(this.OnEnd, null);
        ...
        /// <summary>Callback for the APM function.</summary>
