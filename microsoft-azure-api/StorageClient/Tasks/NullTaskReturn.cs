...
{
    /// <summary>A NullTaskReturn type.</summary>
    internal class NullTaskReturn
    {
        #region Constants and Fields

        /// <summary>Represents a no-return from a task.</summary>
        ...
        /// <summary>Prevents a default instance of the <see cref="NullTaskReturn"/> class from being created.</summary>
