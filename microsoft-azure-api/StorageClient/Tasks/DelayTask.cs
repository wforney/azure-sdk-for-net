...
namespace Microsoft.WindowsAzure.StorageClient.Tasks
{
    ...
    internal class DelayTask : Task<NullTaskReturn>, IDisposable
    {
        ...
        /// <summary>Stores the length of the delay.</summary>
        private readonly TimeSpan delayInterval;

        /// <summary>ObjectUsed to lock disposing methods and timer callbacks.</summary>
        ...
        /// <summary>Stores the native timer used to trigger after the specified delay.</summary>
        private Timer timer;
        ...
        /// <summary>Initializes a new instance of the <see cref="DelayTask"/> class.</summary>
        ...
        {
            CommonUtils.AssertInBounds("delayInterval", delayInterval, TimeSpan.Zero, TimeSpan.MaxValue);
        ...
        /// <summary>Begins the delay.</summary>
        ...
        /// <summary>Ends the delay.</summary>
