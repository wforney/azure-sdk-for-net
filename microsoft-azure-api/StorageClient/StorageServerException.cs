...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents an exception thrown due to a server-side error.</summary>
    [SuppressMessage("Microsoft.Design", "CA1032:ImplementStandardExceptionConstructors", 
        Justification =
            "Since this exception comes from the server, there must be an HTTP response code associated with it,"
    ...
    public class StorageServerException : StorageException
    {
        ...
        internal StorageServerException(
            StorageErrorCode errorCode, string message, HttpStatusCode statusCode, Exception innerException)
        ...
        /// <summary>Initializes a new instance of the <see cref="StorageServerException"/> class with serialized data.</summary>
