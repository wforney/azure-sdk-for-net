...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents a Windows Azure queue.</summary>
    ...
    public class CloudQueue
    {
        ...
        /// <summary>Stores the queue attributes.</summary>
        private readonly QueueAttributes attributes;

        /// <summary>Uri for the messages.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudQueue"/> class.</summary>
        ...
        internal CloudQueue(bool? usePathStyleUris, string address, StorageCredentials credentials)
        {
            ...
            var baseAddress = NavigationHelper.GetServiceClientBaseAddress(this.Uri, usePathStyleUris);
        ...
        /// <summary>Gets the queue's attributes.</summary>
        ...
        /// <summary>Gets the queue's user-defined metadata.</summary>
        ...
        /// <summary>Gets the <see cref="CloudQueueClient"/> object that represents the Queue service.</summary>
        ...
        /// <summary>Gets the URI that identifies the queue.</summary>
        ...
        /// <summary>Gets the Uri for general message operations.</summary>
        /// <value>The message request address.</value>
        ...
        public void AddMessage(CloudQueueMessage message)
        {
            ...
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.AddMessageImpl(message, null, null), this.ServiceClient.RetryPolicy);
        }
        ...
        public void AddMessage(CloudQueueMessage message, TimeSpan timeToLive)
        {
            CommonUtils.AssertNotNull("message", message);
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.AddMessageImpl(message, timeToLive, null), this.ServiceClient.RetryPolicy);
        }
        ...
        public void AddMessage(CloudQueueMessage message, TimeSpan? timeToLive, TimeSpan? initialVisibilityDelay)
        {
            CommonUtils.AssertNotNull("message", message);
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.AddMessageImpl(message, timeToLive, initialVisibilityDelay), this.ServiceClient.RetryPolicy);
        }

        /// <summary>Begins an asynchronous operation to add a message to the queue.</summary>
        /// <param name="message">The message to add. </param>
        ...
        public IAsyncResult BeginAddMessage(CloudQueueMessage message, AsyncCallback callback, object state)
        {
            ...
            return TaskImplHelper.BeginImplWithRetry(
                () => this.AddMessageImpl(message, null, null), this.ServiceClient.RetryPolicy, callback, state);
        }
        ...
        public IAsyncResult BeginAddMessage(
            CloudQueueMessage message, TimeSpan timeToLive, AsyncCallback callback, object state)
        {
            CommonUtils.AssertNotNull("message", message);
            return TaskImplHelper.BeginImplWithRetry(
                () => this.AddMessageImpl(message, timeToLive, null), this.ServiceClient.RetryPolicy, callback, state);
        }
            ...
            object state)
        {
            CommonUtils.AssertNotNull("message", message);
            return
                TaskImplHelper.BeginImplWithRetry(
        ...
        /// <summary>Begins an asynchronous operation to clear all messages from the queue.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        {
            return TaskImplHelper.BeginImplWithRetry(
                this.ClearMessagesImpl, this.ServiceClient.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to create a queue.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        /// <summary>Begins an asynchronous operation to create the queue if it does not exist.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginCreateIfNotExist(AsyncCallback callback, object state)
        {
            return TaskImplHelper.BeginImplWithRetry<bool>(
                this.CreateIfNotExistImpl, this.ServiceClient.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to delete the queue.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        /// <summary>Begins an asynchronous operation to delete a message.</summary>
        ...
        public IAsyncResult BeginDeleteMessage(
            string messageId, string popReceipt, AsyncCallback callback, object state)
        {
            return TaskImplHelper.BeginImplWithRetry(
                () => this.DeleteMessageImpl(messageId, popReceipt), this.ServiceClient.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to determine whether the queue exists.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        {
            return TaskImplHelper.BeginImplWithRetry<bool>(
                this.ExistsImpl, this.ServiceClient.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to fetch the queue's attributes.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        {
            return TaskImplHelper.BeginImplWithRetry(
                this.FetchAttributesImpl, this.ServiceClient.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to get a single message from the queue.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        /// <summary>Begins an asynchronous operation to get messages from the queue.</summary>
        ...
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginGetMessages(
            int messageCount, TimeSpan visibilityTimeout, AsyncCallback callback, object state)
        {
            return this.BeginGetMessagesInternal(messageCount, visibilityTimeout, callback, state);
        }

        /// <summary>Begins an asynchronous operation to peek a message from the queue.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        {
            return
                TaskImplHelper.BeginImplWithRetry<IEnumerable<CloudQueueMessage>>(
                    setResult => this.PeekMessagesImpl(1, setResult), this.ServiceClient.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to peek a set of messages from the queue.</summary>
        /// <param name="messageCount">The number of messages to retrieve. </param>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        /// <summary>Begins an asynchronous operation to set the queue's metadata.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        {
            return TaskImplHelper.BeginImplWithRetry(
                this.SetMetadataImpl, this.ServiceClient.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to update the visibility timeout and optionally the content of a message.</summary>
        ...
        /// <summary>Clears all messages from the queue.</summary>
        public void Clear()
        {
        ...
        /// <summary>Creates the queue if it does not exist.</summary>
        ...
        public bool CreateIfNotExist()
        {
            return TaskImplHelper.ExecuteImplWithRetry<bool>(
                this.CreateIfNotExistImpl, this.ServiceClient.RetryPolicy);
        }
        ...
        public void DeleteMessage(CloudQueueMessage message)
        {
            ...
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.DeleteMessageImpl(message.Id, message.PopReceipt), this.ServiceClient.RetryPolicy);
        }
        ...
        {
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.DeleteMessageImpl(messageId, popReceipt), this.ServiceClient.RetryPolicy);
        }

        /// <summary>Ends an asynchronous operation to add a message to the queue.</summary>
        ...
        /// <summary>Ends an asynchronous operation to clear all messages from the queue.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to create a queue.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation.")]
        ...
        /// <summary>Ends an asynchronous operation to create the queue if it does not exist.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        ...
        /// <summary>Ends an asynchronous operation to delete the queue.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to delete a message.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation.")]
        ...
        /// <summary>Ends an asynchronous operation to determine whether the queue exists.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        ...
        /// <summary>Ends an asynchronous operation to fetch the queue's attributes.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation.")]
        ...
        /// <summary>Ends an asynchronous operation to get a single message from the queue.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        ...
        /// <summary>Ends an asynchronous operation to get messages from the queue.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        ...
        /// <summary>Ends an asynchronous operation to peek a message from the queue.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        /// <returns>A message. </returns>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to peek a set of messages from the queue.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        /// <returns>An enumerable collection of messages. </returns>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to set the queue's metadata.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation.")]
        ...
        /// <summary>Ends an asynchronous operation to update the visibility timeout and possibly the contents of a message.</summary>
        ...
        /// <summary>Determines if the queue exists.</summary>
        ...
        /// <summary>Fetches the queue's attributes.</summary>
        public void FetchAttributes()
        {
            TaskImplHelper.ExecuteImplWithRetry(this.FetchAttributesImpl, this.ServiceClient.RetryPolicy);
        }

        /// <summary>Gets a single message from the queue.</summary>
        /// <returns>A message. </returns>
        ...
        /// <summary>Gets a list of messages from the queue.</summary>
        /// <param name="messageCount">The number of messages to retrieve. </param>
        /// <returns>An enumerable collection of messages. </returns>
        ...
        /// <summary>Peeks a message from the queue.</summary>
        /// <returns>A message. </returns>
        public CloudQueueMessage PeekMessage()
        {
            var peekedMessages =
                TaskImplHelper.ExecuteImplWithRetry<IEnumerable<CloudQueueMessage>>(
                    setResult => this.PeekMessagesImpl(1, setResult), this.ServiceClient.RetryPolicy);

            return peekedMessages.FirstOrDefault();
        }

        /// <summary>Peeks a set of messages from the queue.</summary>
        /// <param name="messageCount">The number of messages to retrieve. </param>
        ...
        public IEnumerable<CloudQueueMessage> PeekMessages(int messageCount)
        {
            return
                TaskImplHelper.ExecuteImplWithRetry<IEnumerable<CloudQueueMessage>>(
                    setResult => this.PeekMessagesImpl(messageCount, setResult), this.ServiceClient.RetryPolicy);
        }

        /// <summary>Retrieves the approximate message count for the queue. This method fetches the value from the server and updates the <see cref="ApproximateMessageCount"/> property as well.</summary>
        /// <returns>The approximate message count. </returns>
        public int RetrieveApproximateMessageCount()
        {
            this.FetchAttributes();

            return this.ApproximateMessageCount.GetValueOrDefault();
        }

        /// <summary>Sets the queue's metadata.</summary>
        ...
        public void UpdateMessage(
            CloudQueueMessage message, TimeSpan visibilityTimeout, MessageUpdateFields updateFields)
        {
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.UpdateMessageImpl(message, visibilityTimeout, updateFields), this.ServiceClient.RetryPolicy);
        }
        ...
        /// <summary>Gets the individual message address.</summary>
        /// <param name="messageId">The message id. </param>
        /// <returns>The Uri of the message. </returns>
        internal Uri GetIndividualMessageAddress(string messageId)
        {
            var individualMessageUri = NavigationHelper.AppendPathToUri(
                this.Uri, Constants.Messages + NavigationHelper.Slash + messageId);
            return individualMessageUri;
        }

        /// <summary>Materialize results so that we can close the response object.</summary>
        ...
        private static IEnumerable<CloudQueueMessage> MaterializeAndParseResponse(
            IEnumerable<QueueMessage> protocolList, Func<QueueMessage, CloudQueueMessage> responseProjector)
        {
        ...
        /// <summary>Generates a task sequence for adding a message to the queue.</summary>
        ...
        private TaskSequence AddMessageImpl(
            CloudQueueMessage message, TimeSpan? timeToLive, TimeSpan? initialVisibilityDelay)
        {
            ...
            if (timeToLive != null)
            {
                CommonUtils.AssertInBounds(
                    "timeToLive", timeToLive.Value, TimeSpan.Zero, CloudQueueMessage.MaxTimeToLive);
            ...
            if (initialVisibilityDelay != null)
            {
                CommonUtils.AssertInBounds(
                    ...
                    TimeSpan.Zero, 
                    timeToLive ?? CloudQueueMessage.MaxTimeToLive);
            ...
            var webRequest = QueueRequest.PutMessage(
                this.MessageRequestAddress, 
                this.ServiceClient.Timeout.RoundUpToSeconds(), 
                timeToLiveInSec, 
                initialVisibilityDelayInSec);

            var requestBody = QueueRequest.GenerateMessageRequestBody(this.GenerateMessageContentsForRequest(message));
        ...
        /// <summary>Begins the get messages internal.</summary>
        ...
        private IAsyncResult BeginGetMessagesInternal(
            int? numberOfMesages, TimeSpan? visibilityTimeout, AsyncCallback callback, object state)
        {
            return
                TaskImplHelper.BeginImplWithRetry<IEnumerable<CloudQueueMessage>>(
        ...
        /// <summary>Clears the messages impl.</summary>
        /// <returns>A <see cref="TaskSequence"/> that clears the messages in the queue. </returns>
        private TaskSequence ClearMessagesImpl()
        {
            var webRequest = QueueRequest.ClearMessages(
                this.MessageRequestAddress, this.ServiceClient.Timeout.RoundUpToSeconds());
        ...
        /// <summary>Creates if not exist impl.</summary>
        ...
        private TaskSequence CreateIfNotExistImpl(Action<bool> setResult)
        {
            ...
            catch (StorageClientException e)
            {
                if (e.StatusCode == HttpStatusCode.Conflict
                    && e.ExtendedErrorInformation.ErrorCode == QueueErrorCodeStrings.QueueAlreadyExists)
                {
                    setResult(false);
                }
                else
        ...
        /// <summary>Creates the impl.</summary>
        ...
        /// <summary>Deletes the impl.</summary>
        ...
        /// <summary>Deletes the message impl.</summary>
        /// <param name="messageId">The message id. </param>
        /// <param name="popReceipt">The pop receipt value. </param>
        ...
        private TaskSequence DeleteMessageImpl(string messageId, string popReceipt)
        {
            ...
            var messageUri = this.GetIndividualMessageAddress(messageId);

            var webRequest = QueueRequest.DeleteMessage(
                messageUri, this.ServiceClient.Timeout.RoundUpToSeconds(), popReceipt);
            CommonUtils.ApplyRequestOptimizations(webRequest, -1);
            this.ServiceClient.Credentials.SignRequest(webRequest);
            var task = webRequest.GetResponseAsyncWithTimeout(this.ServiceClient, this.ServiceClient.Timeout);
            yield return task;
        ...
        /// <summary>Existses the impl.</summary>
        /// <param name="setResult">The set result. </param>
        ...
        /// <summary>Fetches the metadata and properties impl.</summary>
        ...
        /// <summary>Generates a suitable string for representing the content of a message in the body of a web request.</summary>
        /// <param name="message">The message. </param>
                ...
                if (this.EncodeMessage)
                {
                    ...
                    if (outgoingMessageString.Length > CloudQueueMessage.MaxMessageSize)
                    {
                        throw new ArgumentException(
                            string.Format(
                                CultureInfo.InvariantCulture, SR.MessageTooLarge, CloudQueueMessage.MaxMessageSize));
                    }
                }
                else
                {
        ...
        /// <summary>Gets the message internal.</summary>
        /// <param name="visibilityTimeout">The visibility timeout. </param>
        /// <returns>The retrieved message. </returns>
        private CloudQueueMessage GetMessageInternal(TimeSpan? visibilityTimeout)
        {
            var messages = this.GetMessagesInternal(1, visibilityTimeout);

            return messages.FirstOrDefault();
        }

        /// <summary>Gets the messages impl.</summary>
        /// <param name="numberOfMessages">The number of messages. </param>
        /// <param name="visibilityTimeout">The visibility timeout. </param>
        /// <param name="setResult">The set result. </param>
        /// <returns>A <see cref="TaskSequence"/> that gets the message. </returns>
        private TaskSequence GetMessagesImpl(
            int? numberOfMessages, TimeSpan? visibilityTimeout, Action<IEnumerable<CloudQueueMessage>> setResult)
        {
            if (visibilityTimeout.HasValue)
            {
                CommonUtils.AssertInBounds(
                    "visibiliyTimeout", visibilityTimeout.Value, TimeSpan.Zero, TimeSpan.MaxValue);
            }
            ...
            var visibilityTimeoutInSec = visibilityTimeout != null ? visibilityTimeout.RoundUpToSeconds() : (int?)null;

            var webRequest = QueueRequest.GetMessages(
                this.MessageRequestAddress, 
                this.ServiceClient.Timeout.RoundUpToSeconds(), 
                numberOfMessages, 
        ...
        /// <summary>Gets the messages internal.</summary>
        /// <param name="numberOfMessages">The number of messages. </param>
        /// <param name="visibilityTimeout">The visibility timeout. </param>
        ...
        /// <summary>Gets the properties and metadata from response.</summary>
        ...
        private void GetPropertiesAndMetadataFromResponse(HttpWebResponse webResponse)
        {
            ...
            var count = QueueResponse.GetApproximateMessageCount(webResponse);
            this.ApproximateMessageCount = string.IsNullOrEmpty(count) ? (int?)null : int.Parse(count);
        }

        /// <summary>Peeks the messages impl.</summary>
        /// <param name="numberOfMessages">The number of messages. </param>
        /// <param name="setResult">The set result. </param>
        ...
        private TaskSequence PeekMessagesImpl(int? numberOfMessages, Action<IEnumerable<CloudQueueMessage>> setResult)
        {
            ...
            {
                CommonUtils.AssertInBounds(
                    "numberOfMessages", numberOfMessages.Value, 0, CloudQueueMessage.MaxNumberOfMessagesToPeek);
            }

            var webRequest = QueueRequest.PeekMessages(
                this.MessageRequestAddress, this.ServiceClient.Timeout.RoundUpToSeconds(), numberOfMessages);
            CommonUtils.ApplyRequestOptimizations(webRequest, -1);
            this.ServiceClient.Credentials.SignRequest(webRequest);
            var task = webRequest.GetResponseAsyncWithTimeout(this.ServiceClient, this.ServiceClient.Timeout);
            yield return task;
        ...
        /// <summary>Sets the metadata impl.</summary>
