...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Enum for Queue message type.</summary>
    internal enum QueueMessageType
    {
        /// <summary>Indicates the message object stores the raw text string.</summary>
        RawString, 

        /// <summary>Indicates the message object stores the Base64-Encoded representation of the raw data.</summary>
        Base64Encoded
    }

    /// <summary>Represents a message in a queue.</summary>
    public class CloudQueueMessage
    {
        #region Constants and Fields

        /// <summary>The maximum message size in bytes.</summary>
        public static readonly long MaxMessageSize = 64 * Constants.KB;

        /// <summary>The maximum number of messages that can be peeked at a time.</summary>
        public static readonly int MaxNumberOfMessagesToPeek = 32;

        /// <summary>The maximum amount of time a message is kept in the queue.</summary>
        public static readonly TimeSpan MaxTimeToLive = TimeSpan.FromDays(7);

        /// <summary>Custom UTF8Encoder to throw exception in case of invalid bytes.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudQueueMessage"/> class with the given byte array.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudQueueMessage"/> class with the given string.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudQueueMessage"/> class with the given Base64 encoded string. This method is only used internally.</summary>
        ...
        public byte[] AsBytes
        {
            get
            {
                return this.MessageType == QueueMessageType.RawString
                           ? Encoding.UTF8.GetBytes(this.RawString)
                           : Convert.FromBase64String(this.RawString);
            }
        }
        ...
        public string AsString
        {
            get
            {
                return this.MessageType == QueueMessageType.RawString
                           ? this.RawString
                           : Utf8Encoder.GetString(Convert.FromBase64String(this.RawString));
            }
        }

        /// <summary>Gets or sets the number of times this message has been dequeued.</summary>
        /// <value>The number of times this message has been dequeued. </value>
        public int DequeueCount { get; protected internal set; }

        /// <summary>Gets or sets the time that the message expires.</summary>
        ...
        /// <summary>Gets message type that indicates if the RawString is the original message string or Base64 encoding of the original binary data.</summary>
        /// <value>The message type.</value>
        internal QueueMessageType MessageType { get; private set; }

        /// <summary>Gets or sets the original message string or Base64 encoding of the original binary data.</summary>
