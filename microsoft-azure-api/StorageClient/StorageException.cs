...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>The base class for Windows Azure storage service exceptions.</summary>
    [Serializable]
    public abstract class StorageException : Exception
    {
        ...
        /// <param name="context">The <see cref="StreamingContext"/> object that contains contextual information about the source or destionation. </param>
            ...
            : base(info, context)
        {
            ...
            this.ExtendedErrorInformation =
                (StorageExtendedErrorInformation)
                info.GetValue("ExtendedErrorInformation", typeof(StorageExtendedErrorInformation));
        }
        ...
        /// <summary>Gets the specific error code returned by the service.</summary>
        /// <value>The storage error code. </value>
        public StorageErrorCode ErrorCode { get; private set; }

        /// <summary>Gets the extended error information returned by the service.</summary>
        ...
        /// <summary>Gets the HTTP status code that was returned by the service.</summary>
        ...
        /// <summary>Sets the <see cref="SerializationInfo"/> object with additional exception information.</summary>
