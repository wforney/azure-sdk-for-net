...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents a container in the Windows Azure Blob service.</summary>
    public class CloudBlobContainer
    {
        #region Constants and Fields

        /// <summary>Stores the transformed address.</summary>
        ...
        public CloudBlobContainer(string containerAddress, StorageCredentials credentials)
            : this(
                containerAddress, 
                new CloudBlobClient(NavigationHelper.GetServiceClientBaseAddress(containerAddress, null), credentials))
        {
        }
        ...
        public CloudBlobContainer(string containerAddress, CloudBlobClient service)
        {
            ...
            var completeUri = NavigationHelper.AppendPathToUri(this.ServiceClient.BaseUri, containerAddress);

            this.ParseQueryAndVerify(completeUri, this.ServiceClient, this.ServiceClient.UsePathStyleUris);

            this.Name = NavigationHelper.GetContainerNameFromContainerAddress(
                this.Uri, this.ServiceClient.UsePathStyleUris);
        }

        /// <summary>Initializes a new instance of the <see cref="CloudBlobContainer"/> class with the given address and path style Uri preference.</summary>
        ...
        internal CloudBlobContainer(string containerAddress, StorageCredentials credentials, bool usePathStyleUris)
            : this(
                containerAddress, 
                new CloudBlobClient(
                    NavigationHelper.GetServiceClientBaseAddress(containerAddress, usePathStyleUris), credentials))
        {
        }
        ...
        internal CloudBlobContainer(BlobContainerAttributes attrib, CloudBlobClient client)
        {
            ...
            var completeUri = NavigationHelper.AppendPathToUri(this.ServiceClient.BaseUri, attrib.Uri.AbsoluteUri);
        ...
        internal CloudBlobContainer(bool? usePathStyleUris, string containerAddress)
        {
            ...
            var completeUri = new Uri(containerAddress);
        ...
        /// <summary>Gets the container's attributes.</summary>
        ...
        /// <summary>Gets the service client for the container.</summary>
        ...
        /// <summary>Gets the container's URI.</summary>
        ...
        public IAsyncResult BeginCreate(BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return TaskImplHelper.BeginImplWithRetry(
                () => this.CreateContainerImpl(fullModifiers), fullModifiers.RetryPolicy, callback, state);
        }
        ...
        public IAsyncResult BeginDelete(BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return TaskImplHelper.BeginImplWithRetry(
                () => this.DeleteContainerImpl(fullModifiers), fullModifiers.RetryPolicy, callback, state);
        }
        ...
        public IAsyncResult BeginGetPermissions(BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return
                TaskImplHelper.BeginImplWithRetry<BlobContainerPermissions>(
        ...
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginSetPermissions(
            BlobContainerPermissions permissions, AsyncCallback callback, object state)
        {
        ...
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginSetPermissions(
            BlobContainerPermissions permissions, BlobRequestOptions options, AsyncCallback callback, object state)
        {
            var fullModifiers = BlobRequestOptions.CreateFullModifier(this.ServiceClient, options);

            return TaskImplHelper.BeginImplWithRetry(
                () => this.SetPermissionsImpl(permissions, fullModifiers), fullModifiers.RetryPolicy, callback, state);
        }
        ...
        public void Create(BlobRequestOptions options)
        {
            ...
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.CreateContainerImpl(fullModifiers), fullModifiers.RetryPolicy);
        }
        ...
        public void Delete(BlobRequestOptions options)
        {
            ...
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.DeleteContainerImpl(fullModifiers), fullModifiers.RetryPolicy);
        }
        ...
        public BlobContainerPermissions GetPermissions(BlobRequestOptions options)
        {
            ...
            return
                TaskImplHelper.ExecuteImplWithRetry<BlobContainerPermissions>(
                    setResult => this.GetPermissionsImpl(fullModifiers, setResult), fullModifiers.RetryPolicy);
        }
        ...
        public string GetSharedAccessSignature(SharedAccessPolicy policy, string groupPolicyIdentifier)
        {
            ...
            var resourceName = this.GetSharedAccessCanonicalName();
            ...
            var builder = SharedAccessSignatureHelper.GetShareAccessSignatureImpl(
                policy, groupPolicyIdentifier, "c", signature);

            return builder.ToString();
        }

        /// <summary>Returns an enumerable collection of the blobs in the container.</summary>
        ...
        public ResultSegment<IListBlobItem> ListBlobsSegmented(
            int maxResults, ResultContinuation continuationToken, BlobRequestOptions options)
        {
            var fullModifiers = BlobRequestOptions.CreateFullModifier(this.ServiceClient, options);
        ...
        public void SetPermissions(BlobContainerPermissions permissions, BlobRequestOptions options)
        {
            ...
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.SetPermissionsImpl(permissions, fullModifiers), fullModifiers.RetryPolicy);
        }
        ...
        /// <summary>Converts the ACL string to a <see cref="BlobContainerPermissions"/> object.</summary>
            ...
            if (!string.IsNullOrEmpty(aclstring))
            {
                switch (aclstring.ToLower())
                {
                    ...
                    case "blob":
                        ...
                        break;
                    default:
                        var errorMessage = string.Format(CultureInfo.CurrentCulture, SR.InvalidAclType, aclstring);
                        throw new InvalidOperationException(errorMessage);
                }
            }

            return new BlobContainerPermissions { PublicAccess = accessType };
        }

        /// <summary>Implementation for the CreateIfNotExist method.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        private TaskSequence CreateContainerIfNotExistImpl(BlobRequestOptions options, Action<bool> setResult)
        {
            ...
            catch (StorageClientException e)
            {
                if (e.StatusCode == HttpStatusCode.Conflict
                    && e.ExtendedErrorInformation.ErrorCode == StorageErrorCodeStrings.ContainerAlreadyExists)
                {
                    setResult(false);
                }
                else
        ...
        /// <summary>Implementation for the Create method.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        private TaskSequence CreateContainerImpl(BlobRequestOptions options)
        {
            ...
            var webRequest = ProtocolHelper.GetWebRequest(
                this.ServiceClient, options, timeout => ContainerRequest.Create(this.Uri, timeout));
        ...
        /// <summary>Implementation for the Delete method.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        private TaskSequence DeleteContainerImpl(BlobRequestOptions options)
        {
            ...
            var webRequest = ProtocolHelper.GetWebRequest(
                this.ServiceClient, options, timeout => ContainerRequest.Delete(this.TransformedAddress, timeout));
            this.ServiceClient.Credentials.SignRequest(webRequest);
            var task = webRequest.GetResponseAsyncWithTimeout(this.ServiceClient, options.Timeout);
            yield return task;
        ...
        /// <summary>Implementation for the FetchAttributes method.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        private TaskSequence FetchAttributesImpl(BlobRequestOptions options)
        {
            ...
            var webRequest = ProtocolHelper.GetWebRequest(
                this.ServiceClient, 
                options, 
                timeout => ContainerRequest.GetProperties(this.TransformedAddress, timeout));
            this.ServiceClient.Credentials.SignRequest(webRequest);
            var task = webRequest.GetResponseAsyncWithTimeout(this.ServiceClient, options.Timeout);
            yield return task;
        ...
        /// <summary>Gets the absolute Uri of the blob.</summary>
        ...
        /// <summary>Implementation for the GetPermissions method.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <param name="setResult">The result report delegate. </param>
        ...
        private TaskSequence GetPermissionsImpl(BlobRequestOptions options, Action<BlobContainerPermissions> setResult)
        {
            ...
            var webRequest = ProtocolHelper.GetWebRequest(
                this.ServiceClient, options, timeout => ContainerRequest.GetAcl(this.TransformedAddress, timeout));
            this.ServiceClient.Credentials.SignRequest(webRequest);
            var task = webRequest.GetResponseAsyncWithTimeout(this.ServiceClient, options.Timeout);
            yield return task;
            ...
            using (var webResponse = task.Result as HttpWebResponse)
            {
                var publicAccess = ContainerResponse.GetAcl(webResponse);
                ...
                var policyResponse = new AccessPolicyResponse(webResponse.GetResponseStream());
        ...
        /// <summary>Returns the canonical name for shared access.</summary>
        /// <returns>The canonical name. </returns>
        private string GetSharedAccessCanonicalName()
        {
            return this.ServiceClient.UsePathStyleUris
                       ? this.Uri.AbsolutePath
                       : NavigationHelper.GetCanonicalPathFromCreds(
                           this.ServiceClient.Credentials, this.Uri.AbsolutePath);
        }
        ...
        /// <summary>Parse Uri for SAS (Shared access signature) information.</summary>
        ...
        /// <remarks>Validate that no other query parameters are passed in. Any SAS information will be recorded as corresponding credentials instance. If existingClient is passed in, any SAS information found will not be supported. Otherwise a new client is created based on SAS information or as anonymous credentials.</remarks>
        private void ParseQueryAndVerify(Uri completeUri, CloudBlobClient existingClient, bool? usePathStyleUris)
        {
            ...
            else
            {
                this.ServiceClient =
                    new CloudBlobClient(
                        NavigationHelper.GetServiceClientBaseAddress(this.Uri.AbsoluteUri, usePathStyleUris), sasCreds);
            }
        }
        ...
        private TaskSequence SetMetadataImpl(BlobRequestOptions options)
        {
            ...
            var webRequest = ProtocolHelper.GetWebRequest(
                this.ServiceClient, options, timeout => ContainerRequest.SetMetadata(this.TransformedAddress, timeout));
            ContainerRequest.AddMetadata(webRequest, this.Metadata);
            this.ServiceClient.Credentials.SignRequest(webRequest);
            var task = webRequest.GetResponseAsyncWithTimeout(this.ServiceClient, options.Timeout);
            yield return task;
        ...
        /// <summary>Implementation for the SetPermissions method.</summary>
        ...
        private TaskSequence SetPermissionsImpl(BlobContainerPermissions acl, BlobRequestOptions options)
        {
            ...
            using (var memoryStream = new SmallBlockMemoryStream(Constants.DefaultBufferSize))
            {
                ...
                {
                    // Copy the data
                    var copyTask = new InvokeTaskSequenceTask(() => memoryStream.WriteTo(requestStream));
