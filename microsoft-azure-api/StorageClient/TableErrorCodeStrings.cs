...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Provides error code strings that are specific to the Windows Azure Table service.</summary>
    public static class TableErrorCodeStrings
    {
        #region Constants and Fields

        /// <summary>Batch operations are not supported for this operation type.</summary>
        public const string BatchOperationNotSupported = "BatchOperationNotSupported";

        /// <summary>A duplicate key property was specified.</summary>
        public const string DuplicateKeyPropertySpecified = "DuplicateKeyPropertySpecified";

        /// <summary>A property is specified more than once.</summary>
        public const string DuplicatePropertiesSpecified = "DuplicatePropertiesSpecified";

        /// <summary>The specified entity already exists.</summary>
        public const string EntityAlreadyExists = "EntityAlreadyExists";

        /// <summary>The specified entity was not found.</summary>
        public const string EntityNotFound = "EntityNotFound";

        /// <summary>The entity is larger than the maximum size permitted.</summary>
        public const string EntityTooLarge = "EntityTooLarge";

        /// <summary>One or more value types are invalid.</summary>
        public const string InvalidValueType = "InvalidValueType";

        /// <summary>JSON format is not supported.</summary>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Json", 
        ...
        /// <summary>The specified method is not allowed.</summary>
        public const string MethodNotAllowed = "MethodNotAllowed";

        /// <summary>The specified operation is not yet implemented.</summary>
        public const string NotImplemented = "NotImplemented";

        /// <summary>One or more specified operators are invalid.</summary>
        public const string OperatorInvalid = "OperatorInvalid";

        /// <summary>The partition key was not specified.</summary>
        public const string PartitionKeyNotSpecified = "PartitionKeyNotSpecified";

        /// <summary>The partition key property cannot be updated.</summary>
        public const string PartitionKeyPropertyCannotBeUpdated = "PartitionKeyPropertyCannotBeUpdated";

        /// <summary>The type of the primary key property is invalid.</summary>
        public const string PrimaryKeyPropertyIsInvalidType = "PrimaryKeyPropertyIsInvalidType";

        /// <summary>All properties must have values.</summary>
        public const string PropertiesNeedValue = "PropertiesNeedValue";

        /// <summary>The property name is invalid.</summary>
        public const string PropertyNameInvalid = "PropertyNameInvalid";

        /// <summary>The property name exceeds the maximum allowed length.</summary>
        public const string PropertyNameTooLong = "PropertyNameTooLong";

        /// <summary>The property value is larger than the maximum size permitted.</summary>
        ...
        /// <summary>The specified table is being deleted.</summary>
        public const string TableBeingDeleted = "TableBeingDeleted";

        /// <summary>The specified table has no properties.</summary>
        public const string TableHasNoProperties = "TableHasNoProperties";

        /// <summary>The specified table has no such property.</summary>
        public const string TableHasNoSuchProperty = "TableHasNoSuchProperty";

        /// <summary>The specified table was not found.</summary>
        public const string TableNotFound = "TableNotFound";

        /// <summary>The Table service server is out of memory.</summary>
        public const string TableServerOutOfMemory = "TableServerOutOfMemory";

        /// <summary>The entity contains more properties than allowed.</summary>
        public const string TooManyProperties = "TooManyProperties";

        /// <summary>The specified update condition was not satsified.</summary>
        public const string UpdateConditionNotSatisfied = "UpdateConditionNotSatisfied";

        /// <summary>More than one X-HTTP-Method is specified.</summary>
        public const string XMethodIncorrectCount = "XMethodIncorrectCount";

        /// <summary>The specified X-HTTP-Method is invalid.</summary>
        public const string XMethodIncorrectValue = "XMethodIncorrectValue";

        /// <summary>The request uses X-HTTP-Method with an HTTP verb other than POST.</summary>
