...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Provides a set of extensions for the Table service.</summary>
    public static class TableServiceExtensionMethods
    {
        #region Public Methods and Operators

        /// <summary>Converts the query into a <see cref="CloudTableQuery&lt;TElement&gt;"/> object that supports additional operations like retries.</summary>
