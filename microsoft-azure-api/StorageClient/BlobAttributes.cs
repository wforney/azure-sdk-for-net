...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents a blob's attributes.</summary>
    public class BlobAttributes
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="BlobAttributes"/> class.</summary>
        ...
        /// <summary>Gets the date and time that the blob snapshot was taken, if this blob is a snapshot.</summary>
        /// <value>The blob's snapshot time if the blob is a snapshot; otherwise, <c>null</c> . </value>
        /// <remarks>If the blob is not a snapshot, the value of this property is <c>null</c> .</remarks>
        public DateTime? Snapshot { get; internal set; }

        /// <summary>Gets the blob's URI.</summary>
