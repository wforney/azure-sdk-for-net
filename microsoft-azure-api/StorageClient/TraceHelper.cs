...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Tracing helper class.</summary>
    internal class TraceHelper
    {
        #region Constants and Fields

        /// <summary>Internal flag for turning on tracing.</summary>
        ...
        /// <summary>Internal format string for trace messages.</summary>
        ...
        /// <summary>Writes the line internal.</summary>
        /// <param name="format">The format. </param>
        /// <param name="arg">The arguments. </param>
        private static void WriteLineInternal(string format, params object[] arg)
        {
            var traceString = string.Format(format, arg);
            var internalTraceString = string.Format(
                InternalFormat + traceString, Thread.CurrentThread.ManagedThreadId, Environment.TickCount);
