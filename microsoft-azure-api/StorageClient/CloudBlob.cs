...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents a Windows Azure blob.</summary>
    public class CloudBlob : IListBlobItem
    {
        #region Constants and Fields

        /// <summary>Stores the blob's attributes.</summary>
        private readonly BlobAttributes attributes;

        /// <summary>Stores the <see cref="CloudBlobContainer"/> that contains this blob.</summary>
        private CloudBlobContainer container;

        /// <summary>Stores the name of this blob.</summary>
        private string name;

        /// <summary>Stores the blob's parent <see cref="CloudBlobDirectory"/> .</summary>
        private CloudBlobDirectory parent;

        /// <summary>Stores the blob's transformed address.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudBlob"/> class using an absolute URI to the blob.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudBlob"/> class using an absolute URI to the blob and a set of credentials.</summary>
        /// <param name="blobAbsoluteUri">The absolute URI to the blob. </param>
        /// <param name="credentials">The account credentials. </param>
        public CloudBlob(string blobAbsoluteUri, StorageCredentials credentials)
            : this(
                blobAbsoluteUri, 
                new CloudBlobClient(NavigationHelper.GetServiceClientBaseAddress(blobAbsoluteUri, null), credentials))
        {
        }

        /// <summary>Initializes a new instance of the <see cref="CloudBlob"/> class using an absolute URI to the blob, and the snapshot timestamp, if the blob is a snapshot.</summary>
        /// <param name="blobAbsoluteUri">The absolute URI to the blob. </param>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudBlob"/> class using a relative URI to the blob, and the snapshot timestamp, if the blob is a snapshot.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudBlob"/> class using a relative URI to the blob.</summary>
        /// <param name="blobUri">The relative URI to the blob, beginning with the container name. </param>
        /// <param name="serviceClient">A client object that specifies the endpoint for the Blob service. </param>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudBlob"/> class based on an existing instance.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudBlob"/> class.</summary>
        /// <param name="blobAbsoluteUri">Absolute Uri. </param>
        /// <param name="usePathStyleUris">True to use path style Uri. </param>
        /// <remarks>Any authentication information inside the address will be used. Otherwise a blob for anonymous access is created. Any snapshot information as part of the address will be recorded Explicity specify whether to use host style or path style Uri.</remarks>
        internal CloudBlob(string blobAbsoluteUri, bool usePathStyleUris)
            : this(usePathStyleUris, blobAbsoluteUri)
        {
        }

        /// <summary>Initializes a new instance of the <see cref="CloudBlob"/> class creating a new service client.</summary>
        ...
        internal CloudBlob(string blobAbsoluteUri, StorageCredentials credentials, bool usePathStyleUris)
            : this(
                blobAbsoluteUri, 
                new CloudBlobClient(
                    NavigationHelper.GetServiceClientBaseAddress(blobAbsoluteUri, usePathStyleUris), credentials))
        {
        }

        /// <summary>Initializes a new instance of the <see cref="CloudBlob"/> class with the given absolute Uri.</summary>
        /// <param name="usePathStyleUris">True to use path style Uris. </param>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudBlob"/> class with existing attributes.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudBlob"/> class using the specified blob Uri. Note that this is just a reference to a blob instance and no requests are issued to the service yet to update the blob properties, attribute or metaddata. FetchAttributes is the API that issues such request to the service.</summary>
        ...
        /// <param name="containerReference">The reference to the parent container. </param>
        internal CloudBlob(
            string blobUri, DateTime? snapshotTime, CloudBlobClient serviceClient, CloudBlobContainer containerReference)
        ...
        /// <summary>Gets the <see cref="BlobAttributes"/> object that represents the blob's attributes.</summary>
        ...
        /// <summary>Gets a <see cref="CloudBlobContainer"/> object representing the blob's container.</summary>
        ...
        /// <summary>Gets the blob's user-defined metadata.</summary>
        ...
        /// <summary>Gets the blob's name.</summary>
                ...
                if (string.IsNullOrEmpty(this.name))
                {
                    this.name =
                        Uri.UnescapeDataString(
                            NavigationHelper.GetBlobName(this.Uri, this.ServiceClient.UsePathStyleUris));
                }
        ...
        /// <summary>Gets the <see cref="CloudBlobDirectory"/> object representing the virtual parent directory for the blob.</summary>
        ...
        public CloudBlobDirectory Parent
        {
            get
            {
                return this.parent
                       ??
                       (this.parent =
                        new CloudBlobDirectory(
                            NavigationHelper.GetParentAddress(
                                this.Uri, this.ServiceClient.DefaultDelimiter, this.ServiceClient.UsePathStyleUris),
                            this.ServiceClient));
            }
        }
        ...
        /// <summary>Gets the <see cref="CloudBlobClient"/> object that represents the Blob service.</summary>
        /// <value>A client object that specifies the Blob service endpoint. </value>
        public CloudBlobClient ServiceClient { get; private set; }

        /// <summary>Gets the <see cref="DateTime"/> value that uniquely identifies the snapshot, if this blob is a snapshot.</summary>
        /// <value>A value that uniquely identfies the snapshot. </value>
        /// <remarks>If the blob is not a snapshot, this property returns <c>null</c> .</remarks>
        public DateTime? SnapshotTime
        {
            get
            {
                return this.attributes.Snapshot;
            }

            internal set
            {
                this.attributes.Snapshot = value;
            }
        }

        /// <summary>Gets a <see cref="CloudBlockBlob"/> object based on this blob.</summary>
        ...
        /// <summary>Gets a <see cref="CloudPageBlob"/> object based on this blob.</summary>
        ...
        /// <summary>Gets the URI that identifies the blob.</summary>
        ...
        /// <summary>Gets the Uri after applying authentication transformation.</summary>
        ...
        /// <summary>Begins an asynchronous operation to copy a blob's contents, properties, and metadata to a new blob.</summary>
        ...
        /// <summary>Begins an asynchronous operation to copy another blob's contents, properties, and metadata to the blob referenced by this <see cref="CloudBlob"/> object.</summary>
        /// <param name="source">The source blob. </param>
        ...
        public IAsyncResult BeginCopyFromBlob(
            CloudBlob source, BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return TaskImplHelper.BeginImplWithRetry(
                () => this.CopyFromBlobImpl(source, fullModifiers), fullModifiers.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to create a snapshot of the blob.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        public IAsyncResult BeginCreateSnapshot(
            NameValueCollection metadata, BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return
                TaskImplHelper.BeginImplWithRetry<CloudBlob>(
        ...
        /// <summary>Begins an asynchronous operation to delete the blob.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        public IAsyncResult BeginDelete(BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return TaskImplHelper.BeginImplWithRetry(
                () => this.DeleteBlobImpl(fullModifiers), fullModifiers.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to delete the blob if it exists.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        public IAsyncResult BeginDeleteIfExists(BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return
                TaskImplHelper.BeginImplWithRetry<bool>(
                    setResult => this.DeleteBlobIfExistsImpl(fullModifiers, setResult), 
                    fullModifiers.RetryPolicy, 
                    callback, 
                    state);
        }

        /// <summary>Begins an asynchronous operation to download the contents of a blob to a stream.</summary>
        ...
        public IAsyncResult BeginDownloadToStream(
            Stream target, BlobRequestOptions options, AsyncCallback callback, object state)
        {
            var fullModifiers = BlobRequestOptions.CreateFullModifier(this.ServiceClient, options);
            return TaskImplHelper.BeginImplWithRetry(
                () => this.DownloadToStreamImpl(target, fullModifiers), fullModifiers.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to populate the blob's properties and metadata.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        public IAsyncResult BeginFetchAttributes(BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return TaskImplHelper.BeginImplWithRetry(
                () => this.FetchAttributesImpl(fullModifiers), fullModifiers.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to update the blob's metadata.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        public IAsyncResult BeginSetMetadata(BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return TaskImplHelper.BeginImplWithRetry(
                () => this.SetMetadataImpl(fullModifiers), fullModifiers.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to update the blob's properties.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        public IAsyncResult BeginSetProperties(BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return TaskImplHelper.BeginImplWithRetry(
                () => this.SetPropertiesImpl(fullModifiers), fullModifiers.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to upload a stream to a block blob.</summary>
        ...
        public virtual IAsyncResult BeginUploadFromStream(
            Stream source, BlobRequestOptions options, AsyncCallback callback, object state)
        {
            this.VerifyNoWriteOperationForSnapshot();
            ...
            return TaskImplHelper.BeginImpl(
                () => this.UploadFromStreamDispatch(source, fullModifier), callback, state);
        }

        /// <summary>Copies an existing blob's contents, properties, and metadata to a new blob.</summary>
        /// <param name="source">The source blob. </param>
        ...
        /// <summary>Copies a blob's contents, properties, and metadata to a new blob.</summary>
        /// <param name="source">The source blob. </param>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        public void CopyFromBlob(CloudBlob source, BlobRequestOptions options)
        {
            ...
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.CopyFromBlobImpl(source, fullModifiers), fullModifiers.RetryPolicy);
        }

        /// <summary>Creates a snapshot of the blob.</summary>
        ...
        public CloudBlob CreateSnapshot(NameValueCollection metadata, BlobRequestOptions options)
        {
            ...
            return
                TaskImplHelper.ExecuteImplWithRetry<CloudBlob>(
                    setResult => this.CreateSnapshotImpl(metadata, fullModifiers, setResult), 
                    fullModifiers.RetryPolicy);
        }
        ...
        /// <summary>Deletes the blob if it exists.</summary>
        ...
        public bool DeleteIfExists(BlobRequestOptions options)
        {
            ...
            return
                TaskImplHelper.ExecuteImplWithRetry<bool>(
                    setResult => this.DeleteBlobIfExistsImpl(fullModifiers, setResult), fullModifiers.RetryPolicy);
        }

        /// <summary>Downloads the blob's contents as an array of bytes.</summary>
        ...
        /// <summary>Downloads the blob's contents.</summary>
        ...
        {
            var encoding = GetDefaultEncoding();

            var array = this.DownloadByteArray(options);

            return encoding.GetString(array);
        }

        /// <summary>Downloads the blob's contents to a file.</summary>
        ...
        /// <summary>Downloads the contents of a blob to a stream.</summary>
        /// <param name="target">The target stream. </param>
        ...
        {
            var fullModifiers = BlobRequestOptions.CreateFullModifier(this.ServiceClient, options);
            TaskImplHelper.ExecuteSyncTaskWithRetry(
                this.DownloadToStreamSyncImpl(target, fullModifiers), fullModifiers.RetryPolicy);
        }

        /// <summary>Ends an asynchronous operation to copy a blob's contents, properties, and metadata to a new blob.</summary>
        ...
        /// <summary>Ends an asynchronous operation to create a snapshot of the blob.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        /// <returns>A blob snapshot. </returns>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to delete the blob.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to delete the blob if it exists.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        ...
        /// <summary>Ends an asynchronous operation to download the contents of a blob to a stream.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to populate the blob's properties and metadata.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to update the blob's metadata.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to update the blob's properties.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to upload a stream to a block blob.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        ...
        /// <summary>Populates a blob's properties and metadata.</summary>
        ...
        public void FetchAttributes(BlobRequestOptions options)
        {
            ...
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.FetchAttributesImpl(fullModifiers), fullModifiers.RetryPolicy);
        }

        /// <summary>Returns a shared access signature for the blob.</summary>
        ...
        public string GetSharedAccessSignature(SharedAccessPolicy policy, string groupPolicyIdentifier)
        {
            ...
            if (this.SnapshotTime != null)
            {
                var errorMessage = string.Format(CultureInfo.CurrentCulture, SR.CannotCreateSASForSnapshot);
                throw new NotSupportedException(errorMessage);
            }

            var resourceName = this.GetCanonicalName(true);

            var signature = SharedAccessSignatureHelper.GetSharedAccessSignatureHashImpl(
                policy, groupPolicyIdentifier, resourceName, this.ServiceClient);

            // Future resource type changes from "b" => "blob"
            var builder = SharedAccessSignatureHelper.GetShareAccessSignatureImpl(
                policy, groupPolicyIdentifier, "b", signature);

            return builder.ToString();
        }

        /// <summary>Opens a stream for reading the blob's contents.</summary>
        ...
        {
            var fullModifiers = BlobRequestOptions.CreateFullModifier(this.ServiceClient, options);
            return new BlobReadStream(
                this, 
                fullModifiers, 
                this.ServiceClient.ReadAheadInBytes, 
                this.ServiceClient.UseIntegrityControlForStreamReading);
        }

        /// <summary>Opens a stream for writing to the blob.</summary>
        ...
        /// <summary>Updates the blob's properties.</summary>
        ...
        /// <summary>Uploads an array of bytes to a block blob.</summary>
        ...
        /// <summary>Uploads an array of bytes to a blob.</summary>
        /// <param name="content">The array of bytes to upload. </param>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        /// <summary>Uploads a file from the file system to a block blob.</summary>
        ...
        /// <summary>Uploads a stream to a block blob.</summary>
        /// <param name="source">The stream providing the blob content. </param>
        ...
        public virtual void UploadFromStream(Stream source, BlobRequestOptions options)
        {
            ...
            TaskImplHelper.ExecuteImpl(() => this.UploadFromStreamDispatch(source, fullModifier));
        }

        /// <summary>Uploads a string of text to a block blob.</summary>
        ...
        /// <summary>Implements the DownloadToStream method.</summary>
        /// <param name="target">The target stream. </param>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        internal TaskSequence DownloadToStreamImpl(Stream target, BlobRequestOptions options)
        {
            ...
            var webResponseTask =
                new InvokeTaskSequenceTask<Stream>(result => this.GetStreamImpl(options, result));
            yield return webResponseTask;

            using (var responseStream = webResponseTask.Result)
            {
                var copyTask = new InvokeTaskSequenceTask(() => responseStream.WriteTo(target));
        ...
        internal SynchronousTask DownloadToStreamSyncImpl(Stream target, BlobRequestOptions options)
        {
            ...
            return new SynchronousTask(
                () =>
                    {
                        using (var responseStream = this.GetStreamSyncImpl(options))
                        {
        ...
        /// <summary>Implements the FetchAttributes method.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        internal TaskSequence FetchAttributesImpl(BlobRequestOptions options)
        {
            ...
            {
                var blobAttributes = BlobResponse.GetAttributes(webResponse);
                ...
                if (this.attributes.Properties.BlobType != BlobType.Unspecified
                    && this.attributes.Properties.BlobType != blobAttributes.Properties.BlobType)
                {
                    throw new InvalidOperationException(SR.BlobTypeMismatchExceptionMessage);
                }

                this.attributes.Properties = blobAttributes.Properties;
                this.attributes.Metadata = blobAttributes.Metadata;
            }
        }

        /// <summary>Implements getting the stream.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <param name="offset">The offset. </param>
        /// <param name="count">The count. </param>
        /// <param name="setResult">The set result. </param>
        /// <returns>A <see cref="TaskSequence"/> that gets the stream. </returns>
        internal TaskSequence GetStreamImpl(
            BlobRequestOptions options, long offset, long count, Action<Stream> setResult)
        {
            CommonUtils.AssertNotNull("options", options);
            ...
            var blobAttributes = BlobResponse.GetAttributes(response);
            this.attributes.Metadata = blobAttributes.Metadata;
            this.attributes.Properties = blobAttributes.Properties;
        ...
        /// <summary>Implements getting the stream without specifying a range.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <param name="setResult">The set result. </param>
        /// <returns>A <see cref="TaskSequence"/> that gets the stream. </returns>
        ...
        internal Stream GetStreamSyncImpl(BlobRequestOptions options)
        {
            ...
            // Retrieve the response
            webRequest.Timeout = (int)options.Timeout.GetValueOrDefault().TotalMilliseconds;
        ...
        /// <summary>Uploads the blob in parallel with blocks.</summary>
        ...
        {
            var uploader = new ParallelUpload(source, options, blockSize, this.ToBlockBlob);

            return uploader.ParallelExecute(this.UploadBlockWithRetry);
        }

        /// <summary>Uploads the blob with buffering.</summary>
        /// <param name="source">The source stream. </param>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <param name="blockSize">The size of the block. </param>
        /// <returns>A <see cref="TaskSequence"/> that uploads the blob. </returns>
        ...
        /// <summary>Uploads the block.</summary>
        /// <param name="source">The source stream. </param>
        ...
        internal TaskSequence UploadBlock(Stream source, string blockId, string contentMD5, BlobRequestOptions options)
        {
            ...
            var request = ProtocolHelper.GetWebRequest(
                this.ServiceClient, 
                options, 
                timeout => BlobRequest.PutBlock(this.TransformedAddress, timeout, blockId, null));
            ...
            var uploadTask =
                new InvokeTaskSequenceTask<WebResponse>(
                    result => this.UploadData(request, source, result));
        ...
        /// <summary>Uploads the block with retry.</summary>
        /// <param name="source">The source stream. </param>
        /// <param name="blockId">The block IS. </param>
        /// <param name="contentMD5">The content MD5. </param>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <returns>A <see cref="Task&lt;NullTaskReturn&gt;"/> that uploads the block. </returns>
        internal Task<NullTaskReturn> UploadBlockWithRetry(
            Stream source, string blockId, string contentMD5, BlobRequestOptions options)
        {
                ...
                () =>
                    {
                        ...
                        return this.UploadBlock(source, blockId, contentMD5, options);
                    }, 
                retryPolicy);
        }

        /// <summary>Uploads the data into the web request.</summary>
        ...
        internal TaskSequence UploadData(HttpWebRequest request, Stream source, Action<WebResponse> result)
        {
            ...
            {
                var copyTask = new InvokeTaskSequenceTask(() => source.WriteTo(outputStream));
                yield return copyTask;
        ...
        /// <summary>Dispatches the stream upload to a specific implementation method.</summary>
        /// <param name="source">The source stream. </param>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <returns>A <see cref="TaskSequence"/> that uploads the stream. </returns>
        [SuppressMessage("Microsoft.Design", "CA1031:DoNotCatchGeneralExceptionTypes", 
            Justification =
                "Stream provides no way to determine if Length is accessible so we must catch all exceptions.")]
        internal TaskSequence UploadFromStreamDispatch(Stream source, BlobRequestOptions options)
        {
            ...
            if (!source.CanSeek)
            {
                return this.ServiceClient.ParallelOperationThreadCount == 1
                           ? this.UploadBlobWithBuffering(source, options, blockSize)
                           : this.ParallelUploadBlobWithBlocks(source, blockSize, options);
            }
            ...
            {
                return this.ServiceClient.ParallelOperationThreadCount == 1
                           ? this.UploadUnknownSizeStream(source, options, blockSize)
                           : this.ParallelUploadBlobWithBlocks(source, blockSize, options);
            }
            ...
            return this.ServiceClient.ParallelOperationThreadCount == 1
                       ? this.UploadBlobWithBlocks(source, options, blockSize)
                       : this.ParallelUploadBlobWithBlocks(source, blockSize, options);
        }

        /// <summary>Uploads the full blob.</summary>
        /// <param name="source">The source stream. </param>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <returns>A <see cref="TaskSequence"/> that uploads the blob. </returns>
        internal TaskSequence UploadFullBlobImpl(Stream source, BlobRequestOptions options)
        {
            ...
            var request = ProtocolHelper.GetWebRequest(
                ...
                options, 
                timeout =>
                BlobRequest.Put(this.TransformedAddress, timeout, this.Properties, this.Properties.BlobType, null, 0));
        ...
        /// <summary>Uploads the full blob with retry.</summary>
        /// <param name="source">The source stream. </param>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <returns>A <see cref="TaskSequence"/> that uploads the blob. </returns>
                ...
                () =>
                    {
                        ...
                        return this.UploadFullBlobImpl(source, options);
                    }, 
                retryPolicy);
        }

        /// <summary>Retreive ETag and LastModified date time from response.</summary>
        ...
        /// <summary>Gets the default encoding for the blob, which is UTF-8.</summary>
        ...
        /// <summary>Parses the blob address query and returns snapshot and SAS.</summary>
        /// <param name="query">The query to parse. </param>
        /// <param name="snapshot">The snapshot value, if any. </param>
        /// <param name="sasCreds">The SAS credentials. </param>
        private static void ParseBlobAddressQuery(
            string query, out string snapshot, out StorageCredentialsSharedAccessSignature sasCreds)
        {
            snapshot = null;
        ...
        /// <summary>Implementation of the CopyFromBlob method.</summary>
        /// <param name="source">The source blob. </param>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        private TaskSequence CopyFromBlobImpl(CloudBlob source, BlobRequestOptions options)
        {
            ...
            var sourceBlobUri = source.GetCanonicalName(false);
            ...
            var webRequest = ProtocolHelper.GetWebRequest(
                ...
                options, 
                timeout =>
                BlobRequest.CopyFrom(
                    this.TransformedAddress, timeout, sourceBlobUri, this.SnapshotTime, header, value, null));
            ...
            // Parse the response
            using (var webResponse = copyTask.Result as HttpWebResponse)
            {
                this.ParseSizeAndLastModified(webResponse);
            }
        }

        /// <summary>Implementation for the CreateSnapshot method.</summary>
        ...
        private TaskSequence CreateSnapshotImpl(
            NameValueCollection metadata, BlobRequestOptions options, Action<CloudBlob> setResult)
        {
            CommonUtils.AssertNotNull("options", options);

            var webRequest = ProtocolHelper.GetWebRequest(
                this.ServiceClient, options, timeout => BlobRequest.Snapshot(this.TransformedAddress, timeout));

            var snapshotAttributes = new BlobAttributes(this.attributes);
            ...
            using (var webResponse = task.Result as HttpWebResponse)
            {
                var snapshotTime = BlobResponse.GetSnapshotTime(webResponse);

                var snapshot = new CloudBlob(snapshotAttributes, this.ServiceClient, snapshotTime);
        ...
        /// <summary>Implementation for the DeleteIfExists method.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <param name="setResult">The set result. </param>
        ...
        /// <summary>Implements the DeleteBlob method.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        private TaskSequence DeleteBlobImpl(BlobRequestOptions options)
        {
            ...
            var webRequest = ProtocolHelper.GetWebRequest(
                ...
                timeout =>
                BlobRequest.Delete(
                    this.TransformedAddress, timeout, this.SnapshotTime, options.DeleteSnapshotsOption, null));
        ...
        /// <summary>Gets the canonical name of the blob, formatted as /&lt;account-name&gt;/&lt;container-name&gt;/&lt;blob-name&gt;. If <c>ignoreSnapshotTime</c> is <c>false</c> and this blob is a snapshot, the canonical name is augmented with a query of the form ?snapshot=&lt;snapshot-time&gt;. 
        /// <para>This is used by both Shared Access and Copy blob operations.</para>
        /// Used by both Shared Access and Copy blob operation.</summary>
        ...
        {
            var accountName = this.ServiceClient.Credentials.AccountName;
            var containerName = this.Container.Name;
            var blobName = this.Name;

            var canonicalName = string.Format("/{0}/{1}/{2}", accountName, containerName, blobName);

            if (!ignoreSnapshotTime && this.SnapshotTime != null)
            {
                canonicalName += "?snapshot="
                                 + Request.ConvertDateTimeToSnapshotString(this.SnapshotTime.Value.ToUniversalTime());
            }

            return canonicalName;
        }

        /// <summary>Parse Uri for any snapshot and SAS (Shared access signature) information. Validate that no other query parameters are passed in.</summary>
        /// <param name="completeUri">The complete Uri. </param>
        /// <param name="existingClient">The existing blob client. </param>
        /// <param name="usePathStyleUris">True to use path style Uris. </param>
        /// <remarks>Any snapshot information will be saved. Any SAS information will be recorded as corresponding credentials instance. If existingClient is passed in, any SAS information found will not be supported. Otherwise a new client is created based on SAS information or as anonymous credentials.</remarks>
        private void ParseQueryAndVerify(Uri completeUri, CloudBlobClient existingClient, bool? usePathStyleUris)
        {
            ...
            if (!completeUri.IsAbsoluteUri)
            {
                var errorMessage = string.Format(
                    CultureInfo.CurrentCulture, SR.RelativeAddressNotPermitted, completeUri);
            ...
            {
                if (sasCreds != null && existingClient.Credentials != null
                    && !sasCreds.Equals(existingClient.Credentials))
                {
                    var error = string.Format(CultureInfo.CurrentCulture, SR.MultipleCredentialsProvided);
                    throw new ArgumentException(error);
                }
            }
            else
            {
                var credentials = sasCreds ?? StorageCredentialsAnonymous.Anonymous;
                this.ServiceClient = new CloudBlobClient(
                    usePathStyleUris, 
                    new Uri(NavigationHelper.GetServiceClientBaseAddress(this.Uri.AbsoluteUri, usePathStyleUris)), 
                    credentials);
            }
        }

        /// <summary>Parses the snapshot time.</summary>
        /// <param name="snapshotTime">The snapshot time. </param>
        ...
        private DateTime ParseSnapshotTime(string snapshotTime)
        {
            ...
            if (
                !DateTime.TryParse(
                    snapshotTime, CultureInfo.InvariantCulture, DateTimeStyles.AdjustToUniversal, out snapshotDateTime))
            {
            ...
            {
                var errorMessage = string.Format(
                    CultureInfo.CurrentCulture, SR.MultipleSnapshotTimesProvided, snapshotDateTime, this.SnapshotTime);
        ...
        /// <summary>Implementation for the SetMetadata method.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        /// <summary>Implementation for the SetProperties method.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        /// <summary>Uploads the blob with blocks.</summary>
        /// <param name="source">The source stream. </param>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <param name="blockSize">The size of the block. </param>
        /// <returns>A <see cref="TaskSequence"/> that uploads the blob. </returns>
        ...
        /// <summary>Uploads the full blob with a retry sequence.</summary>
        /// <param name="source">The source stream. </param>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <returns>A <see cref="TaskSequence"/> that uploads the blob. </returns>
        ...
        /// <summary>Uploads a stream that doesn't have a known length. In this case we can't do any optimizations like creating a request before we read all of the data.</summary>
        ...
        /// <summary>Verifies that write operation is not done for snapshot.</summary>
        private void VerifyNoWriteOperationForSnapshot()
        {
            if (this.SnapshotTime != null)
            {
                var errorMessage = string.Format(CultureInfo.CurrentCulture, SR.CannotModifySnapshot);
                throw new ArgumentException(errorMessage);
            }
        }
