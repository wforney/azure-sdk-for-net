...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents extended error information returned by the Windows Azure storage services.</summary>
    [Serializable]
    public class StorageExtendedErrorInformation
    {
        ...
        /// <summary>Gets the storage service error code.</summary>
        /// <value>The storage service error code. </value>
        public string ErrorCode { get; internal set; }

        /// <summary>Gets the storage service error message.</summary>
