...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents the system properties for a blob.</summary>
    public class BlobProperties
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="BlobProperties"/> class.</summary>
        ...
        /// <summary>Gets or sets the cache-control value stored for the blob.</summary>
        /// <value>The blob's cache-control value. </value>
        public string CacheControl { get; set; }

        /// <summary>Gets or sets the content-encoding value stored for the blob.</summary>
        /// <value>The blob's content-encoding value. </value>
        /// <remarks>If this property has not been set for the blob, it returns null.</remarks>
        public string ContentEncoding { get; set; }

        /// <summary>Gets or sets the content-language value stored for the blob.</summary>
        /// <value>The blob's content-language value. </value>
        /// <remarks>If this property has not been set for the blob, it returns null.</remarks>
        public string ContentLanguage { get; set; }

        /// <summary>Gets or sets the content-MD5 value stored for the blob.</summary>
        /// <value>The blob's content-MD5 hash. </value>
        public string ContentMD5 { get; set; }

        /// <summary>Gets or sets the content-type value stored for the blob.</summary>
        /// <value>The blob's content-type value. </value>
        /// <remarks>If this property has not been set for the blob, it returns null.</remarks>
        public string ContentType { get; set; }

        /// <summary>Gets the blob's ETag value.</summary>
        /// <value>The blob's ETag value. </value>
        [SuppressMessage("Microsoft.Naming", "CA1702:CompoundWordsShouldBeCasedCorrectly", MessageId = "ETag", 
            Justification = "ETag is the proper capitalization.")]
        public string ETag { get; internal set; }

        /// <summary>Gets the the last-modified time for the blob, expressed as a UTC value.</summary>
        /// <value>The blob's last-modified time, in UTC format. </value>
        public DateTime LastModifiedUtc { get; internal set; }

        /// <summary>Gets the blob's lease status.</summary>
        ...
        /// <summary>Gets the size of the blob, in bytes.</summary>
