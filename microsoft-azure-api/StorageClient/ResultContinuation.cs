...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Manage continuation information for various listing operation. Can be serialized using XmlSerialization.</summary>
    [Serializable]
    public sealed class ResultContinuation : IXmlSerializable
    {
        #region Constants and Fields

        /// <summary>Stores the current token version value.</summary>
        private const string CurrentVersion = "1.0";

        /// <summary>XML element for the next marker.</summary>
        private const string NextMarkerElement = "NextMarker";

        /// <summary>XML element for the next partition key.</summary>
        private const string NextPartitionKeyElement = "NextPartitionKey";

        /// <summary>XML element for the next row key.</summary>
        private const string NextRowKeyElement = "NextRowKey";

        /// <summary>XML element for the next table name.</summary>
        private const string NextTableNameElement = "NextTableName";

        /// <summary>XML element for the token type.</summary>
        private const string TypeElement = "Type";

        /// <summary>XML element for the token version.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="ResultContinuation"/> class.</summary>
        ...
        /// <summary>Specifies the type of a continuation token.</summary>
        internal enum ContinuationType
        {
            /// <summary>Default for no continuation.</summary>
            None = 0, 

            /// <summary>The token is a blob listing continuation token.</summary>
            Blob, 

            /// <summary>The token is a queue listing continuation token.</summary>
            Queue, 

            /// <summary>The token is a container listing continuation token.</summary>
            Container, 

            /// <summary>The token is a table query continuation token.</summary>
            Table
        }
        ...
        /// <summary>Gets a value indicating whether there is continuation information present.</summary>
        /// <returns></returns>
        /// <value>The has continuation.</value>
        internal bool HasContinuation
        {
            get
            {
                return this.NextMarker != null || this.NextPartitionKey != null || this.NextRowKey != null
                       || this.NextTableName != null;
            }
        }

        /// <summary>Gets or sets the NextMarker for continuing results for CloudBlob and CloudBlobContainer and CloudQueue enumeration operations.</summary>
        /// <value>The next marker. </value>
        internal string NextMarker { get; set; }

        /// <summary>Gets or sets the NextPartitionKey for TableServiceEntity enumeration operations.</summary>
        /// <value>The next partition key.</value>
        internal string NextPartitionKey { get; set; }

        /// <summary>Gets or sets the NextRowKey for TableServiceEntity enumeration operations.</summary>
        /// <value>The next row key. </value>
        internal string NextRowKey { get; set; }

        /// <summary>Gets or sets the NextTableName for Table enumeration operations.</summary>
        ...
        /// <summary>Gets an XML representation of an object.</summary>
        ...
        /// <summary>Generates a serializable continuation token from its XML representation.</summary>
                ...
                if (reader.NodeType == XmlNodeType.Element && !reader.IsEmptyElement)
                {
                    switch (reader.Name)
                    {
                        ...
                        case TypeElement:
                            this.Type =
                                (ContinuationType)
                                Enum.Parse(typeof(ContinuationType), reader.ReadElementContentAsString());
                            break;
                    }
                }
                else
        ...
        /// <summary>Converts a serializable continuation token into its XML representation.</summary>
