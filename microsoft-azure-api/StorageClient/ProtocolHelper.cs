...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Assists in protocol implementation.</summary>
    internal class ProtocolHelper
    {
        #region Methods

        /// <summary>Gets the web request.</summary>
        /// <param name="serviceClient">The service client. </param>
        /// <param name="options">The options. </param>
        /// <param name="retrieveRequest">The retrieve request. </param>
        /// <returns>The web request. </returns>
        internal static HttpWebRequest GetWebRequest(
            CloudBlobClient serviceClient, BlobRequestOptions options, Func<int, HttpWebRequest> retrieveRequest)
        {
            CommonUtils.AssertNotNull("options", options);

            var timeoutInSeconds = options.Timeout.RoundUpToSeconds();
            var accessCondition = options.AccessCondition;
