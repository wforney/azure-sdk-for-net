...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents a blob made up of a collection of pages.</summary>
    public class CloudPageBlob : CloudBlob
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="CloudPageBlob"/> class using an absolute URI to the blob.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudPageBlob"/> class using a relative URI to the blob.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudPageBlob"/> class based on an existing <see cref="CloudBlob"/> object.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudPageBlob"/> class using the specified blob Uri. Note that this is just a reference to a blob instance and no requests are issued to the service yet to update the blob properties, attribute or metaddata. FetchAttributes is the API that issues such request to the service.</summary>
        /// <param name="blobAddress">The blob address. </param>
        /// <param name="serviceClient">The service client. </param>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudPageBlob"/> class using the specified blob Uri. If snapshotTime is not null, the blob instance represents a Snapshot. Note that this is just a reference to a blob instance and no requests are issued to the service yet to update the blob properties, attribute or metaddata. FetchAttributes is the API that issues such request to the service.</summary>
        /// <param name="blobAddress">The blob address. </param>
        ...
        /// <summary>Begins an asynchronous operation to clear pages from a page blob.</summary>
        ...
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginClearPages(
            long startOffset, long length, BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return TaskImplHelper.BeginImplWithRetry(
                () => this.ClearPageImpl(startOffset, length, fullModifiers), fullModifiers.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to create a page blob.</summary>
        ...
        public IAsyncResult BeginCreate(long size, BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return TaskImplHelper.BeginImplWithRetry(
                () => this.CreateImpl(fullModifiers, size), fullModifiers.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to return a collection of page ranges and their starting and ending bytes.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        public IAsyncResult BeginGetPageRanges(BlobRequestOptions options, AsyncCallback callback, object state)
        {
            ...
            return
                TaskImplHelper.BeginImplWithRetry<IEnumerable<PageRange>>(
        ...
        /// <summary>Begins an asynchronous operation to upload a blob from a stream.</summary>
        ...
        /// <summary>Begins an asynchronous operation to write pages to a page blob.</summary>
        ...
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginWritePages(
            Stream pageData, long startOffset, BlobRequestOptions options, AsyncCallback callback, object state)
        {
            var fullModifiers = BlobRequestOptions.CreateFullModifier(this.ServiceClient, options);

            var sourcePosition = pageData.CanSeek ? pageData.Position : 0;
        ...
        /// <summary>Clears pages from a page blob.</summary>
        /// <param name="startOffset">The offset at which to begin clearing pages, in bytes. The offset must be a multiple of 512. </param>
        /// <param name="length">The length of the data range to be cleared, in bytes. The length must be a multiple of 512. </param>
        ...
        public void ClearPages(long startOffset, long length, BlobRequestOptions options)
        {
            ...
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.ClearPageImpl(startOffset, length, fullModifiers), fullModifiers.RetryPolicy);
        }

        /// <summary>Creates a page blob.</summary>
        /// <param name="size">The maximum size of the page blob, in bytes. </param>
        ...
        /// <summary>Ends an asynchronous operation to clear pages from a page blob.</summary>
        ...
        /// <summary>Ends an asynchronous operation to create a page blob.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation.")]
        ...
        /// <summary>Ends an asynchronous operation to return a collection of page ranges and their starting and ending bytes.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        ...
        /// <summary>Ends an asynchronous operation to upload a blob from a stream.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        /// <exception cref="NotSupportedException">This operation is not supported on objects of type<see cref="CloudPageBlob"/>.</exception>
        ...
        /// <summary>Ends an asynchronous operation to write pages to a page blob.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Gets a collection of page ranges and their starting and ending bytes.</summary>
        /// <returns>An enumerable collection of page ranges. </returns>
        ...
        public IEnumerable<PageRange> GetPageRanges(BlobRequestOptions options)
        {
            ...
            return
                TaskImplHelper.ExecuteImplWithRetry<IEnumerable<PageRange>>(
                    setResult => this.GetPageRangesImpl(fullModifiers, setResult), fullModifiers.RetryPolicy);
        }
        ...
        /// <summary>Uploads a file from the file system to a blob.</summary>
        ...
        /// <summary>Uploads a blob from a stream.</summary>
        ...
        /// <summary>Uploads a string of text to a blob.</summary>
        ...
        /// <summary>Writes pages to a page blob.</summary>
        /// <param name="pageData">A stream providing the page data. </param>
        /// <param name="startOffset">The offset at which to begin writing, in bytes. The offset must be a multiple of 512. </param>
        ...
        /// <summary>Creates an exception reporting that the creation method is not supported.</summary>
        /// <returns>The created exception. </returns>
        private static NotSupportedException ThisCreationMethodNotSupportedException()
        {
            var errorMessage = string.Format(CultureInfo.CurrentCulture, SR.NotSupportedForPageBlob);
            return new NotSupportedException(errorMessage);
        }

        /// <summary>Implementation method for the ClearPage methods.</summary>
        ...
        private TaskSequence ClearPageImpl(long startOffset, long length, BlobRequestOptions options)
        {
            ...
            var properties = new PutPageProperties
                {
                   Range = new PageRange(startOffset, startOffset + length - 1), PageWrite = PageWrite.Clear, 
                };
            ...
            // Parse the response
            using (var webResponse = responseTask.Result as HttpWebResponse)
            {
                this.ParseSizeAndLastModified(webResponse);
            }
        }

        /// <summary>Implements the Create method.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        private TaskSequence CreateImpl(BlobRequestOptions options, long sizeInBytes)
        {
            ...
            var webRequest = ProtocolHelper.GetWebRequest(
                ...
                options, 
                timeout =>
                BlobRequest.Put(this.TransformedAddress, timeout, this.Properties, BlobType.PageBlob, null, sizeInBytes));
        ...
        /// <summary>Gets the page ranges impl.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        private TaskSequence GetPageRangesImpl(BlobRequestOptions options, Action<IEnumerable<PageRange>> setResult)
        {
            ...
            var webRequest = ProtocolHelper.GetWebRequest(
                this.ServiceClient, 
                options, 
                timeout => BlobRequest.GetPageRanges(this.TransformedAddress, timeout, this.SnapshotTime, null));
            BlobRequest.AddMetadata(webRequest, this.Metadata);
            this.ServiceClient.Credentials.SignRequest(webRequest);
            var task = webRequest.GetResponseAsyncWithTimeout(this.ServiceClient, options.Timeout);
            yield return task;
        ...
        /// <summary>Implementation method for the WritePage methods.</summary>
        ...
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <returns>A <see cref="TaskSequence"/> that writes the pages. </returns>
        private TaskSequence WritePageImpl(
            Stream pageData, long startOffset, long sourceStreamPosition, BlobRequestOptions options)
        {
            CommonUtils.AssertNotNull("options", options);
            ...
            else if (sourceStreamPosition < -1)
            {
                throw new NotSupportedException(
                    string.Format(CultureInfo.CurrentCulture, SR.CannotRetryNonSeekableStreamError));
            }
            ...
            var rangeStreamOffset = pageData.CanSeek ? pageData.Position : 0;
            ...
            if ((1 + properties.Range.EndOffset - properties.Range.StartOffset) % Constants.PageSize != 0
            ...
            {
                var copyTask = new InvokeTaskSequenceTask(() => pageData.WriteTo(outputStream));
