...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Provides a client for accessing the Windows Azure Queue service.</summary>
    public class CloudQueueClient
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="CloudQueueClient"/> class using the specified Queue service endpoint and account credentials.</summary>
        ...
        /// <summary>Gets or sets the lifetime of the approximate message count cache. Obsolete.</summary>
        ...
        [Obsolete(
            "The approximate message count cache is obsolete. Use FetchAttributes to refresh the approximate message count as needed."
            )]
        public TimeSpan ApproximateMessageCountCacheLength { get; set; }

        /// <summary>Gets the base URI for the Queue service client.</summary>
        /// <value>The base URI used to construct the Queue service client. </value>
        public Uri BaseUri { get; private set; }

        /// <summary>Gets the account credentials used to create the Queue service client.</summary>
        /// <value>An object of type <see cref="StorageCredentials"/> . </value>
        public StorageCredentials Credentials { get; private set; }

        /// <summary>Gets or sets the default retry policy for requests made via the Queue service client.</summary>
        /// <value>The retry policy. </value>
        public RetryPolicy RetryPolicy { get; set; }

        /// <summary>Gets or sets the server timeout for requests made via the Queue service client.</summary>
        /// <value>The server timeout interval. </value>
        public TimeSpan Timeout { get; set; }

        /// <summary>Gets a value indicating whether requests made via the Queue service client will employ path-style URIs.</summary>
        ...
        /// <summary>Begins an asynchronous operation to get the properties of the queue service.</summary>
        ...
        /// <summary>Begins an asynchronous operation to return a result segment containing a collection of queues in the storage account.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        ...
        /// <summary>Begins an asynchronous operation to return a result segment containing a collection of queues whose names begin with the specified prefix.</summary>
        ...
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginListQueuesSegmented(
            string prefix, QueueListingDetails detailsIncluded, AsyncCallback callback, object state)
        {
        ...
        {
            return
                TaskImplHelper.BeginImplWithRetry<ResultSegment<CloudQueue>>(
                    setResult =>
        ...
        /// <summary>Begins an asynchronous operation to set the properties of the queue service.</summary>
        ...
        /// <summary>Ends an asynchronous operation to get the properties of the queue service.</summary>
        ...
        /// <summary>Ends an asynchronous operation to return a result segment containing a collection of queues.</summary>
        ...
        /// <summary>Ends an asynchronous operation to set the properties of the queue service.</summary>
        ...
        /// <summary>Gets a reference to the queue at the specified address.</summary>
        ...
        {
            var queueUri = NavigationHelper.AppendPathToUri(this.BaseUri, queueAddress);

            return new CloudQueue(queueUri, this);
        }

        /// <summary>Gets the properties of the queue service.</summary>
        /// <returns>The queue service properties. </returns>
        ...
        /// <summary>Returns an enumerable collection of the queues in the storage account.</summary>
        ...
        /// <summary>Returns an enumerable collection of the queues in the storage account whose names begin with the specified prefix.</summary>
        /// <param name="prefix">The queue name prefix. </param>
        /// <returns>An enumerable collection of queues. </returns>
        ...
        /// <summary>Returns an enumerable collection of the queues in the storage account whose names begin with the specified prefix and that are retrieved lazily.</summary>
        /// <param name="prefix">The queue name prefix. </param>
        /// <param name="detailsIncluded">One of the enumeration values that indicates which details to include in the listing. </param>
        ...
        {
            return
                CommonUtils.LazyEnumerateSegmented<CloudQueue>(
                    setResult => this.ListQueuesImpl(prefix, detailsIncluded, null, null, setResult), this.RetryPolicy);
        }

        /// <summary>Returns a result segment containing a collection of queues in the storage account.</summary>
        ...
        /// <summary>Sets the properties of the queue service.</summary>
        /// <param name="properties">The queue service properties. </param>
        ...
        /// <summary>Ends the get response.</summary>
        ...
        /// <summary>Lists the queues impl.</summary>
            ...
            Action<ResultSegment<CloudQueue>> setResult)
        {
            ...
            return this.ListQueuesImplCore(prefix, detailsIncluded, continuationToken, pagination, setResult);
        }
        ...
        /// <summary>Selects the response.</summary>
        ...
        {
            var info = new CloudQueue(item.Attributes, this);
            return info;
        }

        /// <summary>Generates a task sequence for setting the properties of the queue service.</summary>
        ...
        private TaskSequence SetServicePropertiesImpl(ServiceProperties properties)
        {
            ...
            var request = QueueRequest.SetServiceProperties(this.BaseUri, this.Timeout.RoundUpToSeconds());
            using (var memoryStream = new MemoryStream())
            {
                try
                {
