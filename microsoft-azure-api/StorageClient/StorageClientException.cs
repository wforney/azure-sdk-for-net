//-----------------------------------------------------------------------
// <copyright file="StorageClientException.cs" company="Microsoft">
...
// </copyright>
// <summary>
//    Contains code for the StorageClientException class.
// </summary>
//-----------------------------------------------------------------------
...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents an exception thrown by the Windows Azure storage client library.</summary>
    [SuppressMessage("Microsoft.Design", "CA1032:ImplementStandardExceptionConstructors", 
        Justification =
            "Since this exception comes from the server, there must be an HTTP response code associated with it, hence we exclude the default constructor taking only a string but no status code.")]
    [Serializable]
    public class StorageClientException : StorageException
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="StorageClientException"/> class.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="StorageClientException"/> class with serialized data.</summary>
