...
{
    /// <summary>Represents the permissions for a container.</summary>
    public class BlobContainerPermissions
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="BlobContainerPermissions"/> class.</summary>
        public BlobContainerPermissions()
        {
            this.PublicAccess = BlobContainerPublicAccessType.Off;
            this.SharedAccessPolicies = new SharedAccessPolicies();
        }
        ...
        /// <summary>Gets or sets the public access setting for the container.</summary>
        /// <value>The public access setting for the container. </value>
        public BlobContainerPublicAccessType PublicAccess { get; set; }

        /// <summary>Gets the set of shared access policies for the container.</summary>
