...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents a result segment that was retrieved from the total set of possible results.</summary>
    ...
    public class ResultSegment<TElement>
    {
        ...
        /// <summary>Stores the closure used to retrieve the next set of results.</summary>
        private readonly Func<Action<ResultSegment<TElement>>, TaskSequence> getNext;

        /// <summary>Stores the <see cref="RetryPolicy"/> used for requests.</summary>
        private readonly RetryPolicy retryPolicy;

        /// <summary>Stores the continuation token used to retrieve the next segment of results.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="ResultSegment{TElement}"/> class. Initializes a new instance of the ResultSegment class.</summary>
        ...
        internal ResultSegment(
            IEnumerable<TElement> result,
            bool moreResults,
            Func<Action<ResultSegment<TElement>>, TaskSequence> getNext,
        ...
        /// <summary>Gets a continuation token to use to retrieve the next set of results with a subsequent call to the operation.</summary>
        ...
        /// <summary>Gets a value indicating whether there are additional results to retrieve.</summary>
        /// <value><c>True</c> if there are additional results; otherwise, <c>false</c> . </value>
        public bool HasMoreResults { get; private set; }

        /// <summary>Gets an enumerable collection of results.</summary>
        ...
        /// <summary>Gets or sets the pagination information for Results.</summary>
        ...
        /// <summary>Begins an asynchronous operation to retrieve the next result segment.</summary>
        ...
        {
            CommonUtils.AssertSegmentResultNotComplete(this);

            return TaskImplHelper.BeginImplWithRetry<ResultSegment<TElement>>(
                this.GetNextImpl, this.retryPolicy, callback, state);
        }

        /// <summary>Ends an asynchronous operation to retrieve the next result segment.</summary>
        ...
        /// <summary>Gets the next result segment.</summary>
        /// <returns>The next result segment. </returns>
        ...
        /// <summary>Implementation of GetNext (For symmetry with normal tasks.</summary>
    ...
    /// <summary>Represents a helper class to support additional operations on ResultSegments such as grouping of results into pages.</summary>
    [SuppressMessage("Microsoft.StyleCop.CSharp.MaintainabilityRules", "SA1402:FileMayOnlyContainASingleClass",
    ...
    internal static class ResultSegment
    {
        ...
        /// <summary>Create a result segment from the result result.</summary>
        ...
        {
            Debug.Assert(resultList != null, "resultList != null");
            var result = resultList.ToList();
            pagination.UpdatePaginationForResult(result.Count());
        ...
        /// <summary>Checks if the result segment has more results in the current page if pagination is used. If pagination is not used, it checks if a valid continuation is present.</summary>
        /// <param name="pagination">The pagination. </param>
        /// <param name="continuationToken">The continuation token. </param>
        /// <returns>Returns <c>true</c> if there are more results in the page; otherwise, <c>false</c> . </returns>
        internal static bool HasMoreResultsInPage(ResultPagination pagination, ResultContinuation continuationToken)
        {
            var hasContinuation = HasContinuation(continuationToken);
        ...
        /// <summary>Checks if the result segment passed in has a valid continuation token.</summary>
        /// <param name="continuation">The continuation. </param>
        /// <returns>Returns <c>true</c> if the specified continuation has continuation; otherwise, <c>false</c> . </returns>
