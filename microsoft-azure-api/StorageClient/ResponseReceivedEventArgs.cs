...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Provides the arguments for the <c>ResponseReceived</c> event.</summary>
    public class ResponseReceivedEventArgs : EventArgs
    {
        #region Public Properties

        /// <summary>Gets an exception returned by the service.</summary>
        ...
        /// <summary>Gets the status description for the request.</summary>
