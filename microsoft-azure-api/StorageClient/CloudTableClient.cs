...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Provides a client for accessing the Windows Azure Table service.</summary>
    public class CloudTableClient
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="CloudTableClient"/> class using the specified Table service endpoint and account credentials.</summary>
        ...
        /// <summary>Gets the base URI for the Table service client.</summary>
        /// <value>The base URI used to construct the Table service client. </value>
        public Uri BaseUri { get; private set; }

        /// <summary>Gets the account credentials used to create the Table service client.</summary>
        /// <value>The account credentials. </value>
        public StorageCredentials Credentials { get; private set; }

        /// <summary>Gets the minimum supported timestamp value for a table entity.</summary>
        ...
        /// <summary>Gets or sets the default retry policy for requests made via the Table service client.</summary>
        /// <value>The retry policy. </value>
        public RetryPolicy RetryPolicy { get; set; }

        /// <summary>Gets or sets the default server timeout for requests made by the Table service client.</summary>
        ...
        /// <summary>Creates the tables needed for the specified service context.</summary>
        /// <param name="serviceContextType">The type of service context. </param>
        /// <param name="baseAddress">The Table service endpoint to use to create the client. </param>
        /// <param name="credentials">The account credentials. </param>
        public static void CreateTablesFromModel(
            Type serviceContextType, string baseAddress, StorageCredentials credentials)
        {
        ...
        /// <summary>Attaches to the specified service context.</summary>
        ...
        /// <summary>Begins an asychronous operation to create a table.</summary>
        ...
        public IAsyncResult BeginCreateTable(string tableName, AsyncCallback callback, object state)
        {
            return TaskImplHelper.BeginImplWithRetry(
                () => this.CreateTableImpl(tableName, null), this.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to create a table with the specified name if it does not already exist.</summary>
        /// <param name="tableName">The table name. </param>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginCreateTableIfNotExist(string tableName, AsyncCallback callback, object state)
        {
            return TaskImplHelper.BeginImpl<bool>(
                setResult => this.CreateTableIfNotExistImpl(tableName, setResult), callback, state);
        }

        /// <summary>Begins an asynchronous operation to delete a table.</summary>
        /// <param name="tableName">The table name. </param>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        ...
        {
            CommonUtils.CheckStringParameter(
                tableName, false, "tableName", Constants.TableServiceMaxStringPropertySizeInChars);
            TableServiceUtilities.CheckTableName(tableName, "tableName");

            return TaskImplHelper.BeginImplWithRetry(
                () => this.DeleteTableImpl(tableName), this.RetryPolicy, callback, state);
        }

        /// <summary>Begins an asynchronous operation to delete the tables if it exists.</summary>
        /// <param name="tableName">The table name. </param>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginDeleteTableIfExist(string tableName, AsyncCallback callback, object state)
        {
            ...
            return TaskImplHelper.BeginImpl<bool>(
                setResult => this.DeleteTableIfExistImpl(tableName, setResult), callback, state);
        }

        /// <summary>Begins an asynchronous operation to determine whether a table exists.</summary>
        /// <param name="tableName">The table name. </param>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        {
            return TaskImplHelper.BeginImpl<bool>(
                setResult => this.DoesTableExistImpl(tableName, setResult), callback, state);
        }

        /// <summary>Begins an asynchronous operation to get the properties of the table service.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        ...
        /// <summary>Begins an asynchronous operation to return a result segment containing a collection of table names in the storage account.</summary>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        ...
        /// <summary>Begins an asynchronous operation to return a result segment containing a collection of table names beginning with the specified prefix.</summary>
        ...
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginListTablesSegmented(
            string prefix, int maxResults, ResultContinuation continuationToken, AsyncCallback callback, object state)
        {
            return
                TaskImplHelper.BeginImplWithRetry<ResultSegment<string>>(
                    setResult => this.ListTablesSegmentedImpl(prefix, maxResults, continuationToken, setResult),
                    this.RetryPolicy,
                    callback,
                    state);
        }

        /// <summary>Begins an asynchronous operation to set the properties of the table service.</summary>
        ...
        /// <summary>Creates a table with specified name.</summary>
        /// <param name="tableName">The table name. </param>
        public void CreateTable(string tableName)
        {
            TaskImplHelper.ExecuteImplWithRetry(() => this.CreateTableImpl(tableName, null), this.RetryPolicy);
        }
        ...
        /// <summary>Deletes the table.</summary>
        /// <param name="tableName">The table name. </param>
        ...
        /// <summary>Checks whether the table exists.</summary>
        /// <param name="tableName">The table name. </param>
        ...
        /// <summary>Ends an asychronous operation to create a table.</summary>
        ...
        /// <summary>Ends an asynchronous operation to create a table with the specified name if it does not already exist.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        /// <returns><c>true</c> if table was created; otherwise, <c>false</c> . </returns>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic",
            Justification = "This is a member-operation.")]
        ...
        /// <summary>Ends an asynchronous operation to delete a table.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic",
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to delete the tables if it exists.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        /// <returns><c>true</c> if the table was deleted; otherwise, <c>false</c> . </returns>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic",
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to determine whether a table exists.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        /// <returns><c>true</c> if table exists; otherwise, <c>false</c> . </returns>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic",
            Justification = "This is a member-operation.")]
        ...
        /// <summary>Ends an asynchronous operation to get the properties of the table service.</summary>
        ...
        /// <summary>Ends an asynchronous operation to return a result segment containing a collection of table names.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        ...
        /// <summary>Ends an asynchronous operation to set the properties of the table service.</summary>
        ...
        /// <summary>Creates a new <see cref="TableServiceContext"/> object for performing operations against the Table service.</summary>
        ...
        /// <summary>Gets the properties of the table service.</summary>
        /// <returns>The table service properties. </returns>
        ...
        /// <summary>Returns an enumerable collection of table names in the storage account.</summary>
        ...
        /// <summary>Returns an enumerable collection of table names that begin with the specified prefix and that are retrieved lazily.</summary>
        /// <param name="prefix">The table name prefix. </param>
        ...
        {
            return
                CommonUtils.LazyEnumerateSegmented<string>(
                    setResult => this.ListTablesSegmentedImpl(prefix, null, null, setResult), this.RetryPolicy);
        }

        /// <summary>Returns a result segment containing a collection of table names in the storage account.</summary>
        /// <returns>A result segment containing table names. </returns>
        ...
        /// <summary>Returns a result segment containing a collection of table names beginning with the specified prefix.</summary>
        /// <param name="prefix">The table name prefix. </param>
        /// <param name="maxResults">A non-negative integer value that indicates the maximum number of results to be returned at a time, up to the per-operation limit of 5000. If this value is zero, the maximum possible number of results will be returned, up to 5000. </param>
        /// <param name="continuationToken">A continuation token returned by a previous listing operation. </param>
        /// <returns>A result segment containing table names. </returns>
        ...
        {
            return
                this.EndListTablesSegmented(
                    this.BeginListTablesSegmented(prefix, maxResults, continuationToken, null, null));
        }

        /// <summary>Sets the properties of the table service.</summary>
        /// <param name="properties">The table service properties. </param>
        ...
        /// <summary>Gets the result or default.</summary>
        ...
        /// <summary>Creates the table if not exist implementation.</summary>
        /// <param name="tableName">The table name. </param>
        ...
        private TaskSequence CreateTableIfNotExistImpl(string tableName, Action<bool> setResult)
        {
            ...
            {
                var createTableTask =
                    TaskImplHelper.GetRetryableAsyncTask<InvalidOperationException>(
                        resultSetter => this.CreateTableImpl(tableName, resultSetter), this.RetryPolicy);
                ...
                try
                {
                    ...
                    {
                        var exception =
                            Utilities.TranslateDataServiceClientException(createTableTask.Result) as
                            StorageClientException;
                        if (exception != null && exception.ErrorCode == StorageErrorCode.ResourceAlreadyExists
        ...
        /// <summary>Creates the table implementation.</summary>
        /// <param name="tableName">The table name. </param>
        /// <param name="setResult">The set result. </param>
        /// <returns>A sequence of tasks to do the operation. </returns>
        private TaskSequence CreateTableImpl(string tableName, Action<InvalidOperationException> setResult)
        {
            ...
            svc.AddObject(Constants.TableServiceTablesName, new TableServiceTable { TableName = tableName });
        ...
        /// <summary>Deletes table if exists implementation.</summary>
        /// <param name="tableName">The table name. </param>
        /// <param name="setResult">The set result. </param>
        /// <returns>A sequence of tasks to do the operation. </returns>
        private TaskSequence DeleteTableIfExistImpl(string tableName, Action<bool> setResult)
        {
            var doesTableExistTask =
                TaskImplHelper.GetRetryableAsyncTask<bool>(
                    set => this.DoesTableExistImpl(tableName, set), this.RetryPolicy);
            ...
            {
                var deleteTableTask = TaskImplHelper.GetRetryableAsyncTask(
                    () => this.DeleteTableImpl(tableName), this.RetryPolicy);
        ...
        /// <summary>Delete table implementation.</summary>
        /// <param name="tableName">The table name. </param>
        /// <returns>A sequence of tasks to do the operation. </returns>
        private TaskSequence DeleteTableImpl(string tableName)
        {
            ...
            svc.AttachTo(Constants.TableServiceTablesName, table);
        ...
        /// <summary>Verifies whether the table exist implementation.</summary>
        /// <param name="tableName">The table name. </param>
        /// <param name="setResult">The set result. </param>
        /// <returns>A sequence of tasks to do the operation. </returns>
        private TaskSequence DoesTableExistImpl(string tableName, Action<bool> setResult)
        {
            ...
            var tableExistsQuery = (from table in svc.CreateQuery<TableServiceTable>(Constants.TableServiceTablesName)
            ...
            while (true)
            {
                ...
                if (segment == null)
                {
                    tableExistsSegmentTask =
                        TaskImplHelper.GetRetryableAsyncTask<ResultSegment<TableServiceTable>>(
                            setResultInner => tableExistsQuery.ExecuteSegmentedImpl(null, setResultInner),
                            this.RetryPolicy);
                }
                else
                {
                    tableExistsSegmentTask =
                        TaskImplHelper.GetRetryableAsyncTask<ResultSegment<TableServiceTable>>(
                            segment.GetNextImpl, this.RetryPolicy);
                }
        ...
        /// <summary>Generates a task sequence for getting the properties of the table service.</summary>
        ...
        {
            var request = TableRequest.GetServiceProperties(this.BaseUri, this.Timeout.RoundUpToSeconds());
        ...
        /// <summary>Returns an enumerable collection of tables segmented impl.</summary>
        ...
        /// <summary>Returns an enumerable collection of tables segmented implementation.</summary>
        /// <param name="prefix">The prefix. </param>
        /// <param name="continuationToken">The continuation token. </param>
            ...
            Action<ResultSegment<string>> setResult)
        {
            ...
            {
                var svc = this.GetDataServiceContext();
                var query = from table in svc.CreateQuery<TableServiceTable>(Constants.TableServiceTablesName)
                            select table;

                if (prefix != string.Empty)
                {
                    // Append Max char to end  '{' is 1 + 'z' in AsciiTable
                    var uppperBound = prefix + '{';

                    query =
                        query.Where(
                            table =>
                            string.CompareOrdinal(table.TableName, prefix) >= 0 && string.CompareOrdinal(table.TableName, uppperBound) < 0);
                }

                if (pagination.IsPagingEnabled)
                {
                    query = query.Take(pagination.GetNextRequestPageSize().GetValueOrDefault());
                }

                var listTablesQuery = query.AsTableServiceQuery();

                listTablesSegmentedTask =
                    new InvokeTaskSequenceTask<ResultSegment<TableServiceTable>>(
                        setResultInner => listTablesQuery.ExecuteSegmentedImpl(continuationToken, setResultInner));
            }
            else
            {
                listTablesSegmentedTask =
                    new InvokeTaskSequenceTask<ResultSegment<TableServiceTable>>(lastResult.GetNextImpl);
            }
            ...
            {
                setResult(
                    new ResultSegment<string>(
                        lastResult.Results.Select(table => table.TableName),
                        lastResult.HasMoreResults,
                        setResultInner =>
                        this.ListTablesSegmentedImplCore(
                            prefix, lastResult.ContinuationToken, pagination, lastResult, setResultInner),
                        this.RetryPolicy)
                        {
            ...
            {
                setResult(new ResultSegment<string>(new List<string>(), false, null, this.RetryPolicy));
            }
        }

        /// <summary>Generates a task sequence for setting the properties of the table service.</summary>
        ...
        private TaskSequence SetServicePropertiesImpl(ServiceProperties properties)
        {
            ...
            var request = TableRequest.SetServiceProperties(this.BaseUri, this.Timeout.RoundUpToSeconds());
            using (var memoryStream = new MemoryStream())
            {
                try
                {
