...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Provides error code strings that are common to all storage services.</summary>
    public static class StorageErrorCodeStrings
    {
        ...
        /// <summary>The specified metadata is invalid.</summary>
        public const string InvalidMetadata = "InvalidMetadata";

        /// <summary>One or more query parameters are invalid.</summary>
        ...
        /// <summary>The specified XML document is invalid.</summary>
        public const string InvalidXmlDocument = "InvalidXmlDocument";

        /// <summary>One or more XML node values are invalid.</summary>
        public const string InvalidXmlNodeValue = "InvalidXmlNodeValue";

        /// <summary>The specified MD5 hash does not match the server value.</summary>
        [SuppressMessage("Microsoft.Naming", "CA1709:IdentifiersShouldBeCasedCorrectly", MessageId = "Md", 
            Justification = "The casing matches the storage constant the identifier represents.")]
        public const string Md5Mismatch = "Md5Mismatch";

        /// <summary>The specified metadata is too large.</summary>
        public const string MetadataTooLarge = "MetadataTooLarge";

        /// <summary>The Content-Length header is required for this request.</summary>
        public const string MissingContentLengthHeader = "MissingContentLengthHeader";

        /// <summary>A required header was missing.</summary>
        ...
        /// <summary>A required XML node was missing.</summary>
        ...
        /// <summary>The input is out of range.</summary>
        public const string OutOfRangeInput = "OutOfRangeInput";

        /// <summary>One or more query parameters are out of range.</summary>
        ...
        /// <summary>The specified resource was not found.</summary>
        public const string ResourceNotFound = "ResourceNotFound";

        /// <summary>The server is busy.</summary>
        public const string ServerBusy = "ServerBusy";

        /// <summary>One or more header values are not supported.</summary>
        public const string UnsupportedHeader = "UnsupportedHeader";

        /// <summary>The specified HTTP verb is not supported.</summary>
        public const string UnsupportedHttpVerb = "UnsupportedHttpVerb";

        /// <summary>One or more query parameters is not supported.</summary>
        public const string UnsupportedQueryParameter = "UnsupportedQueryParameter";

        /// <summary>One or more XML nodes are not supported.</summary>
