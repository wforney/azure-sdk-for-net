...
{
    /// <summary>Represents a range of pages in a page blob.</summary>
    public class PageRange
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="PageRange"/> class.</summary>
        ...
        /// <summary>Gets the ending offset of the page range.</summary>
        /// <value>The ending offset. </value>
        public long EndOffset { get; internal set; }

        /// <summary>Gets the starting offset of the page range.</summary>
        ...
        /// <summary>Returns the content of the page range as a string.</summary>
