...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Implementation helper for task sequences.</summary>
    internal static class TaskImplHelper
    {
        #region Methods

        /// <summary>Begins the impl.</summary>
        ...
        [DebuggerNonUserCode]
        internal static IAsyncResult BeginImpl<T>(
            Func<Action<T>, TaskSequence> impl, AsyncCallback callback, object state)
        {
        ...
        /// <summary>Begins the impl with retry.</summary>
        /// <typeparam name="T">The result type. </typeparam>
        /// <param name="impl">The task implementation. </param>
        ...
        /// <returns>An asynchronous result representing the operation. </returns>
        [DebuggerNonUserCode]
        internal static IAsyncResult BeginImplWithRetry<T>(
            Func<Action<T>, TaskSequence> impl, RetryPolicy policy, AsyncCallback callback, object state)
        {
            CommonUtils.AssertNotNull("impl", impl);
        ...
        /// <returns>An asynchronous result representing the operation. </returns>
        [DebuggerNonUserCode]
        internal static IAsyncResult BeginImplWithRetry(
            Func<TaskSequence> impl, RetryPolicy policy, AsyncCallback callback, object state)
        {
            CommonUtils.AssertNotNull("impl", impl);
            CommonUtils.AssertNotNull("policy", policy);
        ...
        {
            var task = GetTaskFromAsyncResult<T>(asyncResult);
        ...
        {
            var task = GetTaskFromAsyncResult<NullTaskReturn>(asyncResult);
            task.EndInvoke();
            task.Dispose();
        }

        /// <summary>Ends the impl with retry.</summary>
        /// <typeparam name="T">The result type. </typeparam>
        /// <param name="asyncResult">The async result. </param>
        /// <returns>The task result. </returns>
        [DebuggerNonUserCode]
        ...
        /// <summary>Executes the impl.</summary>
        /// <typeparam name="T">The result type. </typeparam>
        /// <param name="impl">The task implementation. </param>
        ...
        /// <summary>Executes the impl with retry.</summary>
        /// <typeparam name="T">The result type. </typeparam>
        /// <param name="impl">The task implementation. </param>
        /// <param name="policy">The policy. </param>
        /// <returns>The task result. </returns>
        ...
        internal static TResult ExecuteSyncTaskWithRetry<TResult>(SynchronousTask<TResult> syncTask, RetryPolicy policy)
        {
            ...
            return RequestWithRetry.RequestWithRetrySyncImpl(oracle, syncTask);
        }

        /// <summary>Gets the retryable async task.</summary>
        /// <typeparam name="T">The result type. </typeparam>
        /// <param name="impl">The task implementation. </param>
        /// <param name="policy">The policy. </param>
        ...
        internal static Task<T> GetRetryableAsyncTask<T>(Func<Action<T>, TaskSequence> impl, RetryPolicy policy)
        {
            ...
            var retryableTask =
                new InvokeTaskSequenceTask<T>(
                    setResult => RequestWithRetry.RequestWithRetryImpl(oracle, impl, setResult));
        ...
        internal static Task<NullTaskReturn> GetRetryableAsyncTask(Func<TaskSequence> impl, RetryPolicy policy)
        {
            ...
            var retryableTask =
                new InvokeTaskSequenceTask(
                    () =>
                    RequestWithRetry.RequestWithRetryImpl<NullTaskReturn>(oracle, setResult => impl(), scratch => { }));

            return retryableTask;
        }

        /// <summary>Gets the task from async result.</summary>
