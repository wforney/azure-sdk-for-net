...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents an item that may be returned by a blob listing operation.</summary>
    public interface IListBlobItem
    {
        #region Public Properties

        /// <summary>Gets the blob item's container.</summary>
        /// <value>The blob item's container. </value>
        CloudBlobContainer Container { get; }

        /// <summary>Gets the blob item's parent.</summary>
        /// <value>The blob item's parent. </value>
        CloudBlobDirectory Parent { get; }

        /// <summary>Gets the URI to the blob item.</summary>
