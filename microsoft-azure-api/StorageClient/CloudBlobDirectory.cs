...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents a virtual directory of blobs, designated by a delimiter character.</summary>
    public class CloudBlobDirectory : IListBlobItem
    {
        #region Constants and Fields

        /// <summary>Stores the parent container.</summary>
        private CloudBlobContainer container;

        /// <summary>Stores the parent directory.</summary>
        private CloudBlobDirectory parent;

        /// <summary>Stores the prefix this directory represents.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudBlobDirectory"/> class given an address and a client.</summary>
        ...
        /// <summary>Gets the container for the virtual directory.</summary>
        ...
        /// <summary>Gets the parent directory for the virtual directory.</summary>
        ...
        /// <summary>Gets the service client for the virtual directory.</summary>
        ...
        /// <summary>Gets the URI that identifies the virtual directory.</summary>
        ...
        /// <summary>Begins an asynchronous request to return a result segment containing a collection of blob items.</summary>
            ...
            object state)
        {
            ...
            return
                TaskImplHelper.BeginImplWithRetry<ResultSegment<IListBlobItem>>(
                    setResult =>
                    this.Container.ListBlobsImpl(this.Prefix, fullModifiers, continuationToken, maxResults, setResult), 
                    fullModifiers.RetryPolicy, 
                    callback, 
                    state);
        }

        /// <summary>Ends an asynchronous request to return a result segment containing a collection of blob items.</summary>
        ...
        /// <summary>Returns a reference to a blob in this virtual directory.</summary>
        ...
        public CloudBlob GetBlobReference(string itemName, DateTime? snapshotTime)
        {
            ...
            var blobUri = NavigationHelper.AppendPathToUri(this.Uri, itemName, this.ServiceClient.DefaultDelimiter);
            return new CloudBlob(blobUri.AbsoluteUri, snapshotTime, this.ServiceClient);
        }

        /// <summary>Returns a reference to a block blob in this virtual directory.</summary>
        ...
        /// <summary>Returns a virtual subdirectory within this virtual directory.</summary>
        ...
        public CloudBlobDirectory GetSubdirectory(string itemName)
        {
            ...
            var subdirectoryUri = NavigationHelper.AppendPathToUri(
                this.Uri, itemName, this.ServiceClient.DefaultDelimiter);
            return new CloudBlobDirectory(subdirectoryUri.AbsoluteUri, this.ServiceClient);
        }

        /// <summary>Returns an enumerable collection of blob items in this virtual directory that is lazily retrieved, either as a flat listing or by virtual subdirectory.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        ...
        public IEnumerable<IListBlobItem> ListBlobs(BlobRequestOptions options)
        {
            ...
            return
                CommonUtils.LazyEnumerateSegmented<IListBlobItem>(
                    setResult => this.Container.ListBlobsImpl(this.Prefix, fullModifiers, null, null, setResult), 
                    fullModifiers.RetryPolicy);
        }

        /// <summary>Returns an enumerable collection of blob items in this virtual directory, either as a flat listing or by virtual subdirectory.</summary>
        ...
        /// <summary>Returns a result segment containing a collection of blob items.</summary>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <returns>A result segment containing objects that implement <see cref="IListBlobItem"/> . </returns>
        ...
        /// <summary>Initializes the prefix.</summary>
