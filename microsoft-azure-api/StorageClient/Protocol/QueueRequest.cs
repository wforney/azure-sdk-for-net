...
namespace Microsoft.WindowsAzure.StorageClient.Protocol
{
    ...
    public static class QueueRequest
    {
        ...
        public static HttpWebRequest List(
            Uri uri, int timeout, ListingContext listingContext, QueueListingDetails detailsIncluded)
        {
            var builder = new UriQueryBuilder();
        ...
        /// <param name="visibilityTimeout"> The length of time from now during which the message will be invisible, in seconds. If null, the message will be visible immediately. </param>
        /// <returns> A web request for the put operation. </returns>
        ...
        public static HttpWebRequest UpdateMessage(Uri uri, int timeout, string popReceipt, int visibilityTimeout)
        {
            ...
            builder.Add(Constants.QueryConstants.PopReceipt, popReceipt);
            builder.Add(Constants.QueryConstants.VisibilityTimeout, visibilityTimeout.ToString(CultureInfo.InvariantCulture));
