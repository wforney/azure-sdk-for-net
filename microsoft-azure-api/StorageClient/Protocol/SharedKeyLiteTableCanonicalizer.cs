...
namespace Microsoft.WindowsAzure.StorageClient.Protocol
{
    ...
    /// <summary>
    /// Provides an implementation of the <see cref="CanonicalizationStrategy"/> class for tables for the Shared Key Lite authentication scheme.
    /// </summary>
    public sealed class SharedKeyLiteTableCanonicalizer : CanonicalizationStrategy
    {
        ...
        public override string CanonicalizeHttpRequest(HttpWebRequest request, string accountName)
        {
            ...
            AppendStringToCanonicalizedString(
                canonicalizedString, GetCanonicalizedResource(request.Address, accountName));
