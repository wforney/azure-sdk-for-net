...
namespace Microsoft.WindowsAzure.StorageClient.Protocol
{
    ...
    public static class ContainerRequest
    {
        ...
        {
            var containerBuilder = GetContainerUriQueryBuilder();
        ...
        {
            var builder = GetContainerUriQueryBuilder();
        ...
        public static HttpWebRequest List(
            Uri uri, int timeout, ListingContext listingContext, ContainerListingDetails detailsIncluded)
        {
            ...
            using (var writer = XmlWriter.Create(outputStream, settings))
            {
                ...
                foreach (var key in sharedAccessPolicies.Keys)
                {
                    ...
                    writer.WriteElementString(
                        Constants.Start, SharedAccessSignatureHelper.GetDateTimeOrEmpty(policy.SharedAccessStartTime));
                    writer.WriteElementString(
                        Constants.Expiry, SharedAccessSignatureHelper.GetDateTimeOrEmpty(policy.SharedAccessExpiryTime));
                    writer.WriteElementString(
                        Constants.Permission, SharedAccessPolicy.PermissionsToString(policy.Permissions));
