...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents the system properties for a container.</summary>
    public class BlobContainerProperties
    {
        #region Public Properties

        /// <summary>Gets the ETag value for the container.</summary>
        ...
        /// <summary>Gets the container's last-modified time, expressed as a UTC value.</summary>
