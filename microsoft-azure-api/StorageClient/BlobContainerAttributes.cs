...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents a container's attributes, including its properties and metadata.</summary>
    public class BlobContainerAttributes
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="BlobContainerAttributes"/> class.</summary>
        ...
        /// <summary>Gets the user-defined metadata for the container.</summary>
