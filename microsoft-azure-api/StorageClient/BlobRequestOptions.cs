...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents a set of options that may be specified on a request.</summary>
    public class BlobRequestOptions
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="BlobRequestOptions"/> class.</summary>
        public BlobRequestOptions()
        {
            this.AccessCondition = AccessCondition.None;
        }

        /// <summary>Initializes a new instance of the <see cref="BlobRequestOptions"/> class based on an existing instance.</summary>
        ...
        /// <summary>Gets or sets the access condition for the request.</summary>
        ...
        /// <summary>Gets or sets options for listing blobs.</summary>
        /// <value>One of the enumeration values that indicates what items a listing operation will return. </value>
        /// <remarks>This property is applicable only to a request to list blobs.</remarks>
        public BlobListingDetails BlobListingDetails { get; set; }

        /// <summary>Gets or sets the access condition on the source blob, when the request is to copy a blob.</summary>
        /// <value>A structure that specifies any conditional parameters on the request. </value>
        /// <remarks>This property is applicable only to a request that will copy a blob.</remarks>
        public AccessCondition CopySourceAccessCondition { get; set; }

        /// <summary>Gets or sets options for deleting snapshots when a blob is to be deleted.</summary>
        ...
        /// <remarks>This property is applicable only to a request that will delete a blob.</remarks>
        public DeleteSnapshotsOption DeleteSnapshotsOption { get; set; }

        /// <summary>Gets or sets the retry policy for the request.</summary>
        /// <value>The retry policy delegate. </value>
        public RetryPolicy RetryPolicy { get; set; }

        /// <summary>Gets or sets the server and client timeout for the request.</summary>
        /// <value>The server and client timeout interval for the request. </value>
        public TimeSpan? Timeout { get; set; }

        /// <summary>Gets or sets a value indicating whether the blob listing operation will list all blobs in a container in a flat listing, or whether it will list blobs hierarchically, by virtual directory.</summary>
        ...
        /// <summary>Creates the full modifier.</summary>
        /// <typeparam name="T">The type of the options. </typeparam>
        /// <param name="service">The service. </param>
        /// <param name="options">An object that specifies any additional options for the request. </param>
        /// <returns>A full modifier of the requested type. </returns>
        internal static T CreateFullModifier<T>(CloudBlobClient service, T options) where T : BlobRequestOptions, new()
        {
            var fullModifier = options == null ? new T() : options.Clone() as T;

            Debug.Assert(fullModifier != null, "fullModifier != null");
            fullModifier.ApplyDefaults(service);

            return fullModifier;
        }

        /// <summary>Applies the defaults.</summary>
        /// <param name="service">The service. </param>
