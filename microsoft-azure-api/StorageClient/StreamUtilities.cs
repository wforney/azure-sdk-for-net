...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>A class containing common functionality across the two blob streams.</summary>
    internal static class StreamUtilities
    {
        #region Methods

        /// <summary>Verifies the parameters to a read/write operation.</summary>
        /// <param name="buffer">An array of bytes. </param>
        /// <param name="offset">The zero-based byte offset in <paramref name="buffer"/> . </param>
        /// <param name="count">The maximum number of bytes to be access in <paramref name="buffer"/> . </param>
        /// ///
        ...
        /// <summary>Calculates an ongoing hash.</summary>
        ...
        /// <summary>Retrieves the string representation of the hash. (Completes the creation of the hash).</summary>
