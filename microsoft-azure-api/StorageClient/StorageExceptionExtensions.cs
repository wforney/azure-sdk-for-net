...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Provides a set of extensions for translating Exceptions into StorageExceptions.</summary>
    public static class StorageExceptionExtensions
    {
        ...
        /// <summary>Translates a WebException into the corresponding StorageException.</summary>
        /// <param name="exceptionRef">The exception to translate. </param>
        /// <returns>The translated exception. </returns>
