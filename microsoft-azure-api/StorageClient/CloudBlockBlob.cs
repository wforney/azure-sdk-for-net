...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents a blob that is uploaded as a set of blocks.</summary>
    public class CloudBlockBlob : CloudBlob
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="CloudBlockBlob"/> class using an absolute URI to the blob.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudBlockBlob"/> class using a relative URI to the blob.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CloudBlockBlob"/> class based on an existing blob.</summary>
        /// <param name="cloudBlob">The blob to clone. </param>
        internal CloudBlockBlob(CloudBlob cloudBlob)
            : base(cloudBlob)
        {
            this.Properties.BlobType = BlobType.BlockBlob;
        }
        ...
        internal CloudBlockBlob(
            string blobUri, DateTime? snapshotTime, CloudBlobClient client, CloudBlobContainer containerReference)
        ...
        /// <summary>Begins an asynchronous operation to return an enumerable collection of the blob's blocks, using the specified block list filter.</summary>
        /// <param name="blockListingFilter">One of the enumeration values that indicates whether to return committed blocks, uncommitted blocks, or both. </param>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginDownloadBlockList(
            BlockListingFilter blockListingFilter, AsyncCallback callback, object state)
        {
        ...
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginDownloadBlockList(
            BlockListingFilter blockListingFilter, BlobRequestOptions options, AsyncCallback callback, object state)
        {
            var fullModifier = BlobRequestOptions.CreateFullModifier(this.ServiceClient, options);

            return
                TaskImplHelper.BeginImplWithRetry<IEnumerable<ListBlockItem>>(
                    result => this.GetDownloadBlockList(blockListingFilter, fullModifier, result), 
                    fullModifier.RetryPolicy, 
                    callback, 
                    state);
        }

        /// <summary>Begins an asynchronous operation to upload a single block.</summary>
        ...
        /// <param name="contentMD5">An optional hash value that will be used to set the <see cref="BlobProperties.ContentMD5"/> property on the blob. May be <c>null</c> or an empty string. </param>
        /// <param name="callback">The callback delegate that will receive notification when the asynchronous operation completes. </param>
        /// <param name="state">A user-defined object that will be passed to the callback delegate. </param>
        /// <returns>An <see cref="IAsyncResult"/> that references the asynchronous operation. </returns>
        public IAsyncResult BeginPutBlock(
            string blockId, Stream blockData, string contentMD5, AsyncCallback callback, object state)
        {
        ...
        /// <summary>Begins an asynchronous operation to upload a list of blocks to a new or existing blob.</summary>
        ...
        public IAsyncResult BeginPutBlockList(
            IEnumerable<string> blockList, BlobRequestOptions options, AsyncCallback callback, object state)
        {
            var fullModifier = BlobRequestOptions.CreateFullModifier(this.ServiceClient, options);

            var items = blockList.Select(i => new PutBlockListItem(i, BlockSearchMode.Latest)).ToList();

            return TaskImplHelper.BeginImplWithRetry(
                () => this.UploadBlockList(items, fullModifier), fullModifier.RetryPolicy, callback, state);
        }

        /// <summary>Returns an enumerable collection of the committed blocks comprising the blob.</summary>
        ...
        /// <summary>Returns an enumerable collection of the blob's blocks, using the specified block list filter.</summary>
        /// <param name="blockListingFilter">One of the enumeration values that indicates whether to return committed blocks, uncommitted blocks, or both. </param>
        /// <returns>An enumerable collection of objects implementing <see cref="ListBlockItem"/> . </returns>
        ...
        /// <returns>An enumerable collection of objects implementing <see cref="ListBlockItem"/> . </returns>
        public IEnumerable<ListBlockItem> DownloadBlockList(
            BlockListingFilter blockListingFilter, BlobRequestOptions options)
        {
            var fullModifier = BlobRequestOptions.CreateFullModifier(this.ServiceClient, options);

            return
                TaskImplHelper.ExecuteImplWithRetry<IEnumerable<ListBlockItem>>(
                    result => this.GetDownloadBlockList(blockListingFilter, fullModifier, result), 
                    fullModifier.RetryPolicy);
        }

        /// <summary>Ends an asynchronous operation to return an enumerable collection of the blob's blocks, using the specified block list filter.</summary>
        ...
        /// <summary>Ends an asynchronous operation to upload a single block.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Ends an asynchronous operation to upload a list of blocks to a new or existing blob.</summary>
        /// <param name="asyncResult">An <see cref="IAsyncResult"/> that references the pending asynchronous operation. </param>
        [SuppressMessage("Microsoft.Performance", "CA1822:MarkMembersAsStatic", 
            Justification = "This is a member-operation")]
        ...
        /// <summary>Uploads a single block.</summary>
        /// <param name="blockId">A base64-encoded block ID that identifies the block. </param>
        /// <param name="blockData">A stream that provides the data for the block. </param>
        /// <param name="contentMD5">An optional hash value that will be used to set the <see cref="BlobProperties.ContentMD5"/> property on the blob. May be <c>null</c> or an empty string. </param>
        ...
        /// <summary>Uploads a list of blocks to a new or existing blob.</summary>
        /// <param name="blockList">An enumerable collection of block IDs, as base64-encoded strings. </param>
        ...
        public void PutBlockList(IEnumerable<string> blockList, BlobRequestOptions options)
        {
            ...
            TaskImplHelper.ExecuteImplWithRetry(
                () => this.UploadBlockList(items, fullModifier), fullModifier.RetryPolicy);
        }
        ...
        /// <summary>Gets the download block list.</summary>
        ...
        internal TaskSequence GetDownloadBlockList(
            BlockListingFilter typesOfBlocks, BlobRequestOptions options, Action<IEnumerable<ListBlockItem>> setResult)
        {
            var request = ProtocolHelper.GetWebRequest(
                this.ServiceClient, 
                options, 
                timeout =>
                BlobRequest.GetBlockList(this.TransformedAddress, timeout, this.SnapshotTime, typesOfBlocks, null));
        ...
        /// <summary>Uploads the block list.</summary>
        ...
        internal TaskSequence UploadBlockList(List<PutBlockListItem> blocks, BlobRequestOptions options)
        {
            ...
            var request = ProtocolHelper.GetWebRequest(
                this.ServiceClient, 
                options, 
                timeout => BlobRequest.PutBlockList(this.TransformedAddress, timeout, this.Properties, null));
        ...
        {
            var result = new List<ListBlockItem>();
