...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents a queue's attributes.</summary>
    public class QueueAttributes
    {
        #region Constructors and Destructors

        /// <summary>Initializes a new instance of the <see cref="QueueAttributes"/> class.</summary>
        ...
        {
            this.Metadata = other.Metadata != null ? new NameValueCollection(other.Metadata) : new NameValueCollection();
        ...
        /// <summary>Gets the URI for the queue.</summary>
