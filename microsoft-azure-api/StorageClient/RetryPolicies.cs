...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Defines some standard retry policies.</summary>
    public static class RetryPolicies
    {
        #region Constants and Fields

        /// <summary>Indicates the default client backoff value that will be used by a service client, if no other retry policy has been specified.</summary>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Backoff", 
            Justification = "Backoff is a compound term.")]
        public static readonly TimeSpan DefaultClientBackoff = TimeSpan.FromSeconds(30);

        /// <summary>Indicates the default retry count that will be used by a service client, if no other retry policy has been specified.</summary>
        public static readonly int DefaultClientRetryCount = 3;

        /// <summary>Indicates the default maximum backoff value that will be used for a policy returned by <see cref="RetryPolicies.RetryExponential (Int32, TimeSpan)"/> .</summary>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Backoff", 
            Justification = "Backoff is a compound term.")]
        public static readonly TimeSpan DefaultMaxBackoff = TimeSpan.FromSeconds(90);

        /// <summary>Indicates the default minimum backoff value that will be used for a policy returned by <see cref="RetryPolicies.RetryExponential (int, TimeSpan)"/> .</summary>
        [SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Backoff", 
            Justification = "Backoff is a compound term.")]
        ...
        /// <summary>Returns a retry policy that performs no retries.</summary>
        ...
        /// <summary>Returns a retry policy that retries a specified number of times, with a specified fixed time interval between retries.</summary>
        /// <param name="retryCount">A non-negative number indicating the number of times to retry. </param>
        /// <param name="intervalBetweenRetries">The time interval between retries. Use <see cref="System.TimeSpan.Zero"/> to specify that the operation should be retried immediately. </param>
        /// <returns>The retry policy. </returns>
        public static RetryPolicy Retry(int retryCount, TimeSpan intervalBetweenRetries)
        {
            ...
            CommonUtils.AssertInBounds(
                "intervalBetweenRetries", intervalBetweenRetries, TimeSpan.Zero, TimeSpan.MaxValue);
        ...
        /// <summary>Returns a policy that retries a specified number of times with a randomized exponential backoff scheme.</summary>
        /// <param name="retryCount">A non-negative number indicating the number of times to retry. </param>
            ...
            return () => (int currentRetryCount, Exception lastException, out TimeSpan retryInterval) =>
                {
                    if (currentRetryCount < retryCount)
                    {
                        ...
                        var timeToSleepMsec =
                            (int)
                            Math.Min(minBackoff.TotalMilliseconds + increment, maxBackoff.TotalMilliseconds);
