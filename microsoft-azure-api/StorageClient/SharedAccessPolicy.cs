...
namespace Microsoft.WindowsAzure.StorageClient
{
    ...
    /// <summary>Represents a shared access policy, which specifies the start time, expiry time, and permissions for a shared access signature.</summary>
    public class SharedAccessPolicy
    {
        #region Public Properties

        /// <summary>Gets or sets the permissions for a shared access signature associated with this shared access policy.</summary>
        /// <value>The permissions. </value>
        public SharedAccessPermissions Permissions { get; set; }

        /// <summary>Gets or sets the expiry time for a shared access signature associated with this shared access policy.</summary>
        /// <value>The shared access expiry time. </value>
        public DateTime? SharedAccessExpiryTime { get; set; }

        /// <summary>Gets or sets the start time for a shared access signature associated with this shared access policy.</summary>
        ...
        /// <summary>Constructs a <see cref="SharedAccessPermissions"/> object from a permissions string.</summary>
        ...
        /// <summary>Converts the permissions specified for the shared access policy to a string.</summary>
